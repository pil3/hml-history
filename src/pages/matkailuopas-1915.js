...
const MatkailuopasPage = () => {
  return (
    <Layout titleText="Matkailuopas vuodelta 1915">
      ...
      <hr></hr>
      <h2>Hämeenlinna</h2>
      <p>Hämeenlinnan kaapunki sijaitsee Vanajaveden rannalla, Helsingistä Tampereelle kulkevan rautatien varrella.</p>
      <p>Kaupungin perusti Ruotsin kuningattaren Kristiinan käskystä vuonna 1638 Suomen silloinenkenraalikuvernööri Pietari Brahe niemekkeelle Birger Jaarlin vuonna 1249 
        rakentaman Ruununporin eli Tavaslborgin linnan pohjoispuolelle. Tammikuun 19 päivänä 1639, antoi Pietari Brahe HämeenJinnalle, joka alkuaan oli aiottu kauppakaupungiksi 
      ...
      <p>Kaupungin ensimäinen kirkko valmistui vuonna 1652; se oli puusta rakenneltu korkeine lautakattoineen ja sijaitsi edellämainitun niemekkeen pohjoispäässä lähellä rantaa. 
        KeltotapuJi, jossa oli ainoastaan yksi pienempi kello, sijaitsi jonkun matkan päässä kirkosta eteJäänpäin ja näiden välillä oli kaupungin koulutaJo. Kaupungin pappila oli 
        ...
        <div className="flexWrapper">
        <StaticImage className="mx-auto my-3 rounded shadowed" src="../images/content/guide15-img-1.jpg" alt="Juutalaiskortteli"/>
      </div>
      ...
      <p>Tämän jälkeen alkaa kaupunkilaisille tukalat ajat sillä suurin osa kaupunkia oli poltettu tahi hävitetty ja kaupunkilaisia kiellettiin korkean sakon uhalla rakentamasta uudelleen 
        ...
        ehdotelliin useampiakin ja vahvisti hallitsija monta eri asemakarttaa, mutta nämät eivät kaupunkilaisia tyydyttäneet.</p>
      <p>Kun Kustaa III kesäkuun 19 ja 20 päivänä v. 1775 kävi kaupungissa, valittivat kaupunkilaiset hänelle tukalaa asemaansa, heitä kun oli kielletty uudeIleen rakentamasta hävitetlyjä talojaan 
        ...
        kilomelrin matkan päässä linnasia elelään päin sijaitsevalle Niemenlausta-nimiselle mäelle, minne kaupunki sittemmin vuosina 1779-1184 muutettiinkin ja jossa se nykyään sijaitsee. 
        ...
        oli Hämeenlinnan kirkolliseen seurakuntaan jo vuonna 1731 yhdistetty Vanajan pitäjään kuuluvat Saaren ja Ojoisten latokartanot sekä HätiIän ruununvirkatalo ja yhdistettiin tähän seurakuntaan 
        vielä vuonna 1777 lisäksi samaan pitäjään kuuluvat Luhtialan, Kirstulan, Vuorentaan, Parolan ja Järviöisten kylät, joista sittemmin on muodostetu Hämeenlinnan maaseurakunta. Vuonna 1783 
        ...
        varten kirkkoon 4000 S. p. riksiä, ehdolla kuitenkin, ellä kirkko rakennettaisiin hänen hankkimiensa piirustusten mukaan.</p>
      <p>Kun 1808 vuoden sota alkoi, kokoontui suuri osa Suomen sotajoukoista Hämeenlinnaan, mistä osa kuitenkin lähetettiin Suomen itärajalle sekä osa jätettiin puolustamaan linnaa ja kaupunkia. 
        Näiden joukkojen johtaja kenraali C. N. af Klercker oli päättänyt tehdä kovan vastuksen venäläisille joukoille Hämeenlinnan eteläpuolella Hallelmalan harjulla, minne hän sitä varten oli 
        teettänyt vaileja, mutta kun Suomen sotajoukkojen ylijohtaja Mauritz Klingspor maaliskuun 2 päivänä 1808 saapui kaupunkiin, katsoi hän vastuksen turhaksi sekä määräsi sotajoukot siirtymään 
      ...
      <p>Rauhan jälkeen muuttuivat olot kaupungissa vähitellen entisiksi ja uusia taloja rakennettiin toinen toisensa jällleen. Kaupungin silta, joka v. 1740 oli alkuperäiseltä paikallaan muutettu 
      ...
      <p><strong>Ruununporin eli Tavastborgin linna</strong> sijaitsee Vanajaveden rannalla puolen kilometrin päässä kaupungista pohjoiseen päin. 1200 luvun alkupuolella oli kristinusko jo voittanut alaa 
        Hämeen sydämessä, vaikkei se vielä ollut saanut täysin vakautunutta asemaa, pakanalliset hämäläiset kun vihasivat kirkonmiehiä ja vastakastettuja sekä tekivät näille kamalimpia kauhuntöilä. Tämän 
      ...
      <p>Päälinna muodostaa alaltaan säännöllisen neliön, jonka sivut ovat 33 metrin pituiset sekä nurkat näyttävät jotakuinkin tarkkaan eri ilmansuuntiin. Luoteispuolella ulkonee linnasta kuitenkin v. 1607 
        ...
        sekä oviaukot pyöreäkaarisia. Ainoat seinäkoristukset ovat pohjoisen tornin luoteis- ja lounaissivuilla kulkeva harnmastusvyöhyke sekä suunnikasmainen laakea syvänne, joka juoksee linnan itänurkasta 
      ...
      <p>Jo v. 1539, jolloin linnan kunnossapito oli jaettu Hattulan, Sääksmäen ja Hollolan kihlakunlien kesken, oli varsinaisen linnan ympäri rakenneltu tornilla varustettu korkea kehä·muuri, jonka itäiseen kulmaan 
        v. 1539 rakennelliin pyörötorni. Tällaisia pyörötornia rakennettiin kehämuurin ulkopuolelle vielä vuonna 1559, 1563 ja 1581, mutta on näistä meidän aikoihin säilynyt ainoastaan ensiksi mainittu. 
      ...
      <p>Linnanläänin päälliköislä mainitaan ensimäisenä Bartholdus v. 1297 sekä sittemmin Bo juhonpoika Grip, Valdemar Diekn, Olavi Tavast ja Knut Posse. V. 1315 joutui linna Valdemar herttualle ja v. 1371 
        panttasi kuningas Albreht linnan Bo juhonpoika Grip'ille, jonka kuoltua linna lankesi kuningatar Margareetalle. V. 1441 antoi kuningas Kristoffer linnan läänilykseksi Kaarle Knuutinpoika Bondelle 
        ja v. 1451 Eerik l\kselinpoika Tott'ille, juka taasen siirsi Ruununporin linnan ynnä muut suomenmaalaiset läänityksensä veljilleen Iivari ja Lauri Tott'ille. Viimeksimainitun kuoltua jätti Iivari Tott 
        ...
        Aake Tott, kunnes han kuningas Kristian II määräyksestä mestattiin linnassa v. 1520, jolloin Sten Sture nuoremman leski Kristiina Gyl1enstjerna sai linnan kaikkine kuninkaallisine veroineen läänitykseksi. 
        Tämän jälkeen kuului Ruununporin linna vuoden ajan tanskalaisen soturin Söyrinki Norbyn läänityksiin. kunnes sen valloilli Kustaa Vaasan sotajoukot v. 1523, jonka jälkeen linnaa hoitivat kuninkaan 
      ...
      <div className="flexWrapper">
        <StaticImage className="mx-auto my-3 rounded shadowed" src="../images/content/guide15-img-2.jpg" alt="Kirkontornista pohjoiseen"/>
      </div>
      <h2> Matkailijoille huomattavaa</h2>
      <p><strong>Rautatien asema</strong> kaupungin itäsyrjällä Vanajaveden itäisellä puolella, on aistikkaasti rakennettu kolmikerroksinen kivirakennus tornineen, joka aikoinaan oli Suomen ensimäisen Helsingistä 
      ...
      <p><strong>Matkustajakoteja:</strong> Aliina Ahosen matkustajakoti talossa n:o 3 Rantakadun varrella, jossa on raittiusravinto!a sekä 7 matkustajahuonetta 1 markasta 50 pennistä - 4 markkaan vuorokaudessa, 
        ...
        jossa on 4 matkustajahuonetta 1 markasta 50 pennistä 3 markkaan sekä matkustajakoti Vellamo talossa n:o 11 Rantakadun varrella, jossa on 6 matkustajahuoneIla 1 markasta 50 p. korkeinpiin hintoihin.</p>
      ...
      <p>Kreikkalaiskatoolisen seurakunnan kirkko rantatorin luoteiskulmassa, on pieni puukirkko, jonka kauppias Aleksander Bogdanoff v. 1867 lahjoitti kaupungin kreikkalais-katooliselle seurakunnalle, ja 
        ...
        <div className="flexWrapper">
        <StaticImage className="mx-auto my-3 rounded shadowed" src="../images/content/guide15-img-3.jpg" alt="Raatihuone"/>
      </div>
      <p><strong>Lääninhallitus</strong> sijaitsee torin pohjoispuolella. Alkuaan oli Hämeenlääni yhdistetty yhdeksi lääniksi Uudenmaanläänin kanssa, jolloin lääninhallitus sijaitsi Helsingin kaupungissa, kunnes 
        ...
        nykyinen kolmikerroksinen kivirakennus v. 1832 palaneen rakennuksen paikalle sekä sisustettiin rakennuksen alakerrokset lääninhallitusta varten ja ylikerros kuvernöörin asunnoksi. V. 1831 eroilettiin Hämeenlääni 
      ...
      <p><strong>Pankkeja:</strong> Suomen pankin konttori ja Suomen Yhdyspankin konttori viimeksimainitun pankin talossa torin pohjoispuolella, Pohjoismaiden Osakepankin konttori talossa n:o 9 Raasluvankadun varrella 
      ...
      <p><strong>Valokuvaajia:</strong> E. Stier'in jälk. valokuvaamo talossa n:o 1 Läntisen Viertotien varrella ja talossa n:o 13 torin eteläpuolella, sekä Uusi Valokuvaamo Myllymäessä, talossa n:o 6 Itäisen Vuorikadun 
        varrella.</p>
      <p><strong>Vatokuvaustarpeita</strong> myydään E. Rytkösen kirjakaupassa ja F. Gallen'in rohdoskaupassa.</p>
      <p><strong>Saunoja:</strong> Kunnallissauna itäisen Linnankadun ja Koulukadun kulmassa, Uusi kylpylaitos talossa n:o 2 Hallituskadun varrella ja Ranttilan sauna talossa n:o 9 itäisen Torikadun varrella MylIymäen 
        kaupunginosassa.</p>
      ...
      <p><strong>Kouluja</strong> Koulukaupunkina on Hämeenlinnan kaupungilla aina ollut maineensa maassamme. Ensimäisen koulunsa sai Hämeenlinna jo vuonna 1639 Pietari Brahen toimesta. Tämä koulu oli pieni lastenkoulu, 
        ...
        Suomalainen yhteiskoulu talossa n:o 2 Läntisen Viertolien varrella ja Ruotsalainen yhteiskoulu talossa n:o 16 Panimokatu Rantatorin pohjoispuolella. Kaupungin kansakoulut sijaitsevat taloissa n:o 11-13 
      ...
      <div className="flexWrapper">
        <StaticImage className="mx-auto my-3 rounded shadowed" src="../images/content/guide15-img-4.jpg" alt="Puistoravintola"/>
      </div>
      <p><strong>Puistoja</strong> on kaupungissa: Kirkkopuisto lutherilaisen kirkon pohjois- ja eteläpuolella, Tori puisto suihkulähteineen, pergolarakennuksineen ja virvoitusjuomamyymälöineen torin i1äsyrjällä. 
        Tähtipuisto Läntisen ja Itäisen Linnankadun sekä Birger Jaarlinkadun välissä, Rantapuistot kaupungin koillis- ja itärannalla sekä Pinellan puisto sillan itäpuolella. Kilometrin malkan päässä kaupungista 
        pohjoiseen päin Vanajaveden rannalla sijaitsee kaupungin Puisto. KUn vapaaherra Otto Reinhold Rehbinder v. 1841 määrättiin Hämeenläänin kuvernööriksi, otti hän myöskin hallintoonsa kuvernöörin virkatuioihin 
        ...
        paikkoihin varjostavia syreenimajoja. Luopuessaan Ojoisten virkataion hallinnosta v. 1848 pyysi kuvernööri Rehbinder keisari Nikolai 1:ltä, ellä Pyövelinmäki erotellaisiin Ojoislen ruununvirkalaiosta sekä 
        ...
        puistoon ravintolarakennuksen. mikä avattiin yleisölle toukokuun t päivänä 1861 ja jonka rakennuksen mainittu yhtiö seuraavana vuonna lahjoitti kaupungille. Puistoon on sittemmin rakennettu keilarala, soiltolavat 
      ...
      <p><strong>Laivalaituri</strong> on Hallitus- ja Birger JaarIin katujen itäpäässä.</p>
      ...
      kaupungista sijaitsee Parolan leirikenttä. Kenttää, jota kesäisin käyletään sotaväen harjoituskenttänä, käytettiin jo Ruotsin vallan aikana samaan tarkoitukseen. Täällä tarkasti kuningas Kustaa III kesällä v. 
      ...
      sittemmin pystytti leirikentälIe taiteilija Sjöström'in valmistaman pronssileijonan harmaakivi-jalustalle.</p>
      ...
      <p>Hämeenlinnan kaupunki sijaitsee Suomen Jarviylängön länsiosassa, Kokemäenjoen vesistön eleiäisemmän reitin Vanajaveden varrella. Reitti alkaa etelässä likellä Suurta-Salpausselkää ja kiertelee monissa mutkissa 
      ...
      <p>Vanhojen herraskartanoiden sekä lukuisten talojen viljavat vainiot ja rehevät puutarhat, lukuisat huvilat, metsäiset niemet ja vihertävät lehdot hivelevät silmää molemmin puolin laivareittiä, joka sinisenä 
        ...
        Matkalaisille on käynti Hämeenlinnasta Kangasalle erilläin sopiva, se kun vähillä kustannuksilla tarjoo vaihtelevan ja jotakuinkin täydellisen sarjan pikakuvia tuhatjärvisestä maastamme ja sen sisämaan 
      ...
      <p>Sivuutettuamme rantapuiston kohoaa samalla puolella Birger Jarlin v. 1249 perustama vanha linna sammaltuneine muureineen. Siitä enemmän toisessa paikassa. Heti linnan pohjoispuolella oleva alue, missä nykyään 
        ...
        v. 1650 antoi kaupunginoikeudet. Sieltä kaupunki sitten Hustaa III:n elokuun 25 p. 1777 antaman määräyksen mukaan siirrettiin nykyiselle paikalleen.</p>
      ...
      <p>Käänlyessämme jälleen vasemmalle sekä kuljettuamme linnan ja 'Vanhan kaupungin' ohitse, kohoaa vasemmalla tuuheana ja rehoittavana kaupungin kuuluisa 'Parkki' eli Puislo. Vielä viime vuosisadan alkupuolella oli 
      ...
      <p>Näkemistä ansaitsevat myöskin kartanon tilavat kasvihuoneet, jotka sijaitsevat rannalla ja joissa m. m. viljellään viinirypäleitä, persikoila, ananasta sekä muita etelämaalaisia hedelmiä.</p>
      ...
      <div className="flexWrapper">
        <StaticImage className="mx-auto my-3 rounded shadowed" src="../images/content/guide15-img-5.jpg" alt="Karlbergin kartano"/>
      </div>
      ...
      <p>Kun on kuljettu kapeasta Kirsiulan saimesta Hattulan selälle, näemme taas oikealla puolella edelleen Karlbergin alueita, sekä eversti Standertskjöldin niinikään omistamat Katajiston ja Metsänkyiän kartanot; 
        ...
        omistama Kirstulan kartano laajoine vainioineen. Kartanon entisistä omistajista mainiltakoot Karin Horn, Margaretha Spåre, Hämeenlinnan ponnestari Gottrieb John ja kenraali Aug. Standerlskjöld.</p>
      ...
      <p>Kun Herniäisten kartano on sivuutettu, näkyy reitin vasemmalla rannalla loivasti kohoavaIla peltorinteellä maamme mieltäkiinnittävimpiä muinaismuistoja, Hattulan vanha kirkko, josta t:ri F. O. Rapola lausuu 
      ...
      <p>Tämä kirkko, joka nykyään on Suomen muinaismuistoyhdistyksen hoidossa, on rakennettu t300-luvun vaiheilla, ja taru kertoo sen olevan rakenneltu niistä tiilistä, jotka jäivät jälelle Birger Jaarlin v. 1249 
        ...
        kirkko erittäin ehyen vaikutuksen; tätä elävöittää kirkon mieltäkiinnittävä katto- ja seinäkuvitus, joka vasta parikymmentä vuotta sillen saatiin esille, kun sen päällä ollut kalkkimaalaus poistettiin. Kuvitus 
      ...
      <p>Kuljettuamme Lepaan salmesta näemme edessämme Lahdentaan kartanon tornilla varustettuine päärakennuksineen. Kartano, jonka nykyään omisaa tarkastaja Hugo Hallamaa, on tunnettu jo keskiajalta saakka; silloin 
      ...
      <p>Keskellä Vanajan selkää on metsätön Pyterinsaari, jossa Hattulan, Tyrvännön, Sääksmäen ja Kalvolan pitäjät yhtyvät. Kuljetluamme Ruskeenkärjen ohi näemme vasemmalla päin pitkän lahden perukassa Hj. Gulinin 
      ...
      <p>Vastapäätä Lahisten kartanoa Vanajan selän oikealla rannalla sijaitsee Hakalan kartano ja kilometrin matkan päässä tästä pohjoiseen Pohjan saha ynnä samanniminen kartano. Vielä pohjoisempana on Sääksmäen 
        seurakunnan kirkko ja pappila. Kirkko, joka lienee rakennettu v. 1300 vaiheilla harmaasta kivestä. muutettiin v. 1841 ristikirkoksi. Kirkon ymparillä on seurakunnan hautausmaa, jonka patsaissa tapaamme nimiä 
      ...
      <p>Kuljettuamme Sääksmäen kirkon alla olevan niemen ohi, saavumme Rautunselälle, ja sivuutettuamme Rapolan kartanon näemme oikealla rannalla niemekkeellä Salon kylän, jota väitetään Sääksmäen pitäjän vanhimmaksi. 
        Kylän takana lahden pohjukassa sijaitsee Annilan talo, joka useita vuosia oli Vilhelms-suvun hallussa. Vastapäätä Salon kylää vesistön vasemmalla puolella sijaitsevai Vedentaan, Lantosten ja Mustilahden kylät. 
        ...
        puolen sijaitsee Valkiakosken tehdaskylä suurine paperi- ja selluloosatehtaineen. Kylässä on myös höyrysaha, osuusmeijeri ja oluttehdas sekä poslikonttori ja apteekki.</p>
      <p>Kanavan toisella puolella saavumme pian Apian kanavalle. josta eteemme avautuu laaja Mallasvesi. Sen koillispäässä näemme Pälkäneen seurakunnan kauniin kirkon, Syrjän harjun ja Onkkaalan kylän; tämän kylän 
        ...
        seljänteen. Niin kauas kuin silmään siintää nään järviä lahtineen. Kas, Längelmävesi tuolla vöin hopeisin hohlelee, ja Roineen armaiset aallot sen rantoja hyväilee!'</p>

      <h2>Tyrvännön reitti</h2>
      <p>Sivuutettuamme laivareitin oikealla puolella Landentaan kartanon ja Vanajaniemen talon, joka viimeksimainittu kuuluu Suomen Valtion omistamaan Lepaan kartanoon, avartuu Vanajavesi, joka tähän asti on kaarellut 
      ...
      <p>Kuljettuamme Retulan saaren ohi saavumme Monaalan kylän laiturille, jonka läheisyydessä sijaitsee agronoomi A. Koljosen omistama Monaalan kartano sekä niemellä vastapäätä Monaalan kylää Mälkiäisten kyla. 
