...
const JailRulesPage = () => {
  return (
    <Layout titleText="Hämeenlinnan kuritushuoneen järjestyssäännöt">
      ...
      <h2>2 § </h2>
      <p className="initialCap">Wangilta waaditaan:</p>
      <br/>
      ...
      <h2>3 §</h2>
      <p className="initialCap">Wanki on kielletty:</p>
      <br/>
      ...
      <h2>4 §</h2>
      <p className="initialCap">Jos wanki karkaa esimiehensä päälle taikka wastustaa häntä, on esimiehellä oikeus käyttää aseitansa. Jos wanki yrittää karkuun päästä, 
      ...
      <h2>5 §</h2>
      <p className="initialCap">Kun wanki saapuu kuritus-laitokseen, ottaa wahtimestari elikkä selliwangistossa wartiana olewa knihti hänen wastaan. Wastaanottamisesta annetaan 
      ...
      <h2>6 §</h2>
      <p className="initialCap">Jokaiselle wangille, jolla Tirehtöörin takana on rahaa tallessa, annetaan wastakirja, johon rahamäärässä tapahtuneet muutokset kuin myös 
      ...
      <h2>7 §</h2>
      <p className="initialCap">Wangit nousewat arkipäiwinä suwi aikana kello 5 ja muulla wuoden ajalla kl 1/2 6 aamulla, mutta sunnuntai ja juhlapäiwinä pitkin wuotta kello 6. 
      ...
      <h2>8 §</h2>
      <p className="initialCap">Sairashoitoon, pesuun, huoneitten siiwoamiseen, ruan laittamiseen j. n. e. päättää tirehtöri tarpeellisen määrän wankeja.
      </p>

      <h2>9 §</h2>
      <p className="initialCap">Ruan laittaminen sekä jakaminen ja mitä tähän kuuluu on wahtimestarien katsottawana. Selliwangit aterioitsewat kukin erikseen selleissä, mutta 
      ...
      <h2>10 §</h2>
      <p className="initialCap">Jokaisen waateparseilin, mitä wangille annetaan, kirjoittaa wahtimestari erityiseen päiwäkirjaan, johon kaikki waatteita koskewat muutokset 
      ...
      <h2>11 §</h2>
      <p className="initialCap">Puhtauden wuoksi owat wangit usein tutkittawat, ja ne, joissa elämiä tahi ruokottomuutta on, kuin myös heidän waatteensa ja muut heidän 
      ...
      <h2>12 §</h2>
      <p className="initialCap">Merkin saatua tahi esimiehen käskystä, pitää wankien joutumalla ja ilman jyryä saapuman määrätyille kokouspaikoille; ja on 
      ...
      <h2>13 §</h2>
      <p className="initialCap">Jokaisen wangin Ewankelis-lutherilaista uskoa, joka ei ole sairaana tahi erinäisessä sairauden tilassa, pitää käymän Jumalan palweluksessa 
      ...
      <h2>14 §</h2>
      <p className="initialCap">Welwollinen ottamaan osaa alkeisopetuksessa on jokainen wanki, joka ei ole yli sen iän, mikä kuritushuoneessa on määrätty koulu-ajaksi, 
      ...
      <h2>15 §</h2>
      <p className="initialCap">Perustettuja kanteita ilmoitetaan tirehtörille tahi johtokunnalle; mutta jos niitä esitellään häijyydestä, seuraa rangaistus. 
      ...
      <h2>17 §</h2>
      <p className="initialCap">Milloin wanki tarwitsee kirjoittajan apua, määrää tirehtöri siksi jonkun soweliaan miehen.</p>

      <h2>18 §</h2>
      <p className="initialCap">Kaikkinainen kaupanteko wankien kanssa ja kesken, ilman tirehtörin lupaa, on kielletty.</p>

      <h2>19 §</h2>
      <p className="initialCap">Pois lähtewä wanki sioitetaan ehtoota ennen selliin, jota ennen hän tarkasti tutkitaan. Sen jälkeen ei hänen ole lupa kohdata 
      ...
      <h2>20 §</h2>
      <p className="initialCap">Jos wanki rikkoo sitä wastaan kuin tässä yllä on säädetty, joutuu hän rangaistukseen, ja on welwollinen palkitsemaan 
