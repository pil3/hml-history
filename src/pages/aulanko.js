  ...
  return (
    <Layout titleText="Kuvia Aulangolta">
      ...
      <Row>
        ...
        <Col sm={12} md={6} className="marginYStyle">
          <ImageCard
            imgPath="https://digi.kirjastot.fi/files/fullsize/52828cdc64853f24e0f1860984d4d9e7.jpg"
            title="1907"
            copyright="Enok Rytkönen - Hämeenlinnan kaupunginkirjasto"
            caption="Karlbergin kartanon ympärillä oleva edustapuisto rajautui pohjoisen puolella saunarakennukseen ja sähkölaitokseen sekä siihen liittyneisiin rakennelmiin. Eversti Standertskjöld 
            oli innostunut kaikista uusista keksinnöistä. Niinpä hän rakennutti Karlbergiin myös oman sähkölaitoksen. Sähkölaitos oli punatiilinen, pientä linnaa muistuttava rakennus, jossa vesivoiman 
            avulla tuotettiin sähköä koko kartanon alueelle jo 1900-luvun vaihteesta lähtien. Vanha sähkölaitosrakennus on edelleen olemassa nykyisen Aulangon kylpylähotellin vieressä Vanajaveden
      ...
      <Row>
        <Col sm={12} md={6} className="marginYStyle">
          <ImageCard
            ...
            title="1920"
            copyright="Suomalainen kirjakauppa / Hämeenlinna - Hämeenlinnan kaupunginkirjasto"
            caption="Karlbergin kartanoa ympäröivän puiston suunnitelmia ei ole säilynyt. Kartanon puutarhureina toimineiden ruotsalaisten veljesten, Erik ja Karl Zetterlöfin arvellaan vaikuttaneen 
      ...
      <Row>
        <Col sm={12} md={6} className="marginYStyle">
          <ImageCard
            imgPath="https://www.finna.fi/Cover/Show?source=Solr&id=kerava_mui.mui-1273&index=0&size=large"
            title="1926"
            copyright="Keravan museopalvelut - Elna Granqvistin kokoelma - CC BY-NC-ND 4.0"
            caption="Karlbergin kartanon päärakennus Aulangolla elokuussa 1926."
          ></ImageCard>
        </Col>
        <Col sm={12} md={6} className="marginYStyle">
          <ImageCard
