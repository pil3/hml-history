      ...
      <Row>
        ...
        <Col sm={12} md={6} className="marginYStyle">
          <ImageCard
            ...
            caption="Karlbergin kartanon ympärillä oleva edustapuisto rajautui pohjoisen puolella saunarakennukseen ja sähkölaitokseen sekä siihen liittyneisiin rakennelmiin. 
