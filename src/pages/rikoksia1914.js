...
const Crimes1914Page = () => {
  return (
    <Layout titleText="Hämeen Sanomat, 1914">
      ...
      <Article titleText="Salainen ilmianto Hattulassa.">
        <h5>Teknikko P. Teukku saanut haasteen majesteettirikoksesta.</h5>
        <p>Hattulan „Jukolassa” pitämänsä puheen johdosta wiime helluntaina, josta puheesta oli sittemmin tehty ilmianto Hämeenläänin kuwernöörille, on nyttemmin puheenpitäjä, teknikko Paawo Teukku 
      ...
      <Article titleText="Itsepuolustuksessa tehty miesmurha Kärkölässä.">
        <p>Wiime sunnuntaina klo 9:n tienoissa illalla kulki pitkin Hausjärwelle wiewää maantietä polkupyörällä ratawartija Sulo Leimu Lappilan asemalta matkalle tuttawiinsa sanotussa pitäjässä. 
          Hänen edellänsä ajoi hewosella maanwiljelijä Nummela weljensä Nestori Nummelan kanssa, molemmat Lapinnummen kylästä. — Kun wiimemainittu Nestori Nummela huomasi Leimun pyörineen, 
          hyppäsi hän alas kärryiltä ja hyökkäsi pyöräilijän kimppuun lyöden ja uhkaillen häntä. Leimu pyysi saada olla rauhassa. Kun Nummela kuitenkin jatkoi lyöntejään, kohotti ahdistettu 
          ampuma-aseensa sillä seurauksella, että Nummela kuoli silmänräpäyksessä. — Nestori Nummela oli tuossa 25—30 wuoden wälillä; jotenkin samanikäinen on Leimukin, joka muuten on tunnettu 
          kunnon mieheksi. — Mikä lienee perimäisenä syynä tapahtumaan, ei wielä warmuudella tiedetä. Poliisitutkintoa pidetään paraillaan.</p>
      </Article>

      <div className="interTitle">18.7.1914</div>
      <Article titleText="Murha Tammelan Pyhäjärwellä.">
        <p>Olemme saaneet tapahtumasta seuraawia lisätietoja.</p>
        <p>Seurue johon Ilmari Tuomikin kuului oli illalla laskenut pitkänsiiman Pyhäjärween. Aamulla ryhtyiwät he sitä kokemaan mutta ehdittyään katsoa muutaman koukun ilmestyi heidän siwulleen 
          wene, jossa oli 2 miestä. Kysyttyään kenen luwalla pojat kalastiwat oli toinen weneessä olleista miehistä wartija Wirtanen ojentanut haulikkonsa soutamassa ollutta Tuomea kohti ennen 
          kerrotulla seurauksella. Tuomi kuoli noin 2 minuutin kuluttua.</p>
        <p>Ammuttuaan soutiwat wartijat poikain weneen wiereen ja ottiwat, murhatusta sen enempää wälittämättä, takawarikoon siimalatikon ja pistinhaawin sekä soutiwat heti Tammelan kirkonkylään 
          ilmoittamaan tapahtumasta poliisille. Pojat taas säikähdyksestään selwittyään lähtiwät kiireen kaupalla kotia kohti.</p>
        <p>Poliisitutkinnossa on ampuja Wirtanen kertonut, kuten wiime numerossa kerrottiin aikeestaan ampumalla pelottaa, tapaturmasta y. m. Toinen weneessä olleista wartijoista O. Wiik 
          sitawastoin kertoi kieltäneensä Wirtasta asetta käyttämästä mutta tämä ei ollut kiellosta wälittänyt. Wainajan towerit kertowat, että Wirtanen oli ampunut laukauksen mitään warottamatta 
          tai kysymättä. Wieläpä kertowat he kieltäneensä Wirtasta ampumasta, mutta teki tämä sen siitä huolimatta.</p>
        <p>Wirtanen on 35 wuotias ja 5 alaikäisen lapsen isä.</p>
        <p>Tapauksen johdosta kuten jo ennen on mainittu pidettiin kansalaiskokous Forssassa työwäenyhdistyksen talossa t. k. 14 p. Kokouksessa jossa puheenjohtajana toimi E. Alawirta ja 
          sihteerinä A. Aaltonen, keskusteltiin ensin Tammelaan perustetun kalastuskunnan oikeuksista. Keskustelu jäi wastaukseksi kysymykseen kun ei woitu hywäksyä ehdoitettuja päätösponsia. 
          Sitten keskusteltiin itse tapauksesta ja tunnustettiin se yksimielisesti ennen kuulumattomaksi raakalaistyöksi. Kokouksessa myöskin puheenjohtaja mainitsi olewan täysin todistettawissa, 
          että ampuja wiime wiikolla oli lausunut uhkauksia forssalaisia kalastajia kohtaan, jotka uhkaukset nyt owat toteutuneet mitä ikäwimmällä tawalla. Kokous päätti asian johdosta ryhtyä 
          seuraawiin toimenpiteisiin:</p>
        <p>Kun Tammelan poliisit owat tawallaan osallisia myöskin jutun alkuwaiheisiin, nimittäin pyydysten takawarikoimisessa, pidettiin suotawana, että läänin kuwernööri määräisi tutkinnon 
          asiasta toimittamaan jonkun jääwittömän henkilön.</p>
        <p>Wainajan omaista lainopillisesti awustamaan kutsutaan joku warma asiamies, josta huolehtii myöhemmin walittu toimikunta.</p>
        <p>Kun oikeusjuttu tulee kysymään waroja jonkun werran, toiwottiin, että kulut maksetaan yhteisesti.</p>
        <p>Jos aineellinen awustus tulee kysymykseen wainajan läheisimmille omaisille — wainaja oli lesken poika — niin pidettiin luonnollisena, että sen on tultawa siltä taholta, joka on 
          aiheuttanut itse tapahtumankin. Asiasta huolehtimaan walittiin erityinen toimikunta.</p>
        <p>Muuten lausuttiin kokouksessa hywinkin ankaroita sanoja asian eri puolilta.</p>
        <p>Tässä yhteydessä mainittakoon, että kokouksessa ilmeni jälleen sama ikäwä seikka, joka aina waiwaa Forssan kansalaiskokouksia, se nimittäin, että niistä eräältä taholta koetetaan 
          muodostaa agitatsioonikokouksia. Niinpä nytkin kokous oli kutsuttu kokoon tapahtuneen murhan ja siitä johtuwien toimenpiteitten tähden, mutta yksi sielä puhui eduskuntawaalista ja 
          sosialistisista lainlaatijoista, toinen rahawallasta, kolmas urkkimisjärjestelmästä j. n. e. kukin oman asiansa eduksi. Harwat puhujat pysyiwät itse asiassa ja puhtaasti siinä ei 
