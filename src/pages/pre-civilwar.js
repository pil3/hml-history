    ...
    <Layout titleText="Hämeen Sanomat, 1917-18">
      ...
      <Article titleText="Järjen ääniä.">
        <p>Meidän suurin waltiollinen puolueemme on aina ollut tunnettu siitä uskonkiihkoisuuteen wiwahtawasta kuristaan, jossa se pitää jäseniänsä. Jokainen puolueen oikeaksi hywäksymästä 
          uskontunnuksesta poikkeawa ajatus on leimattu itse pahasta syntyneeksi, ja sen esittäjä on harhaoppisuudestaan saanut kärsiä rangaistuksen kuin kerettiläinen konsanaan. Tästä huolimatta 
          ei puolue kuitenkaan ole kyennyt totuutta tukahuttamaan, ja silloin tällöin on senkin keskuudesta kohonnut arwostelewia ääniä, jotka tähän asti owat kuitenkin kyenneet synnyttämään wain 
          myrskyn wesilasissa, samalla kun arwostelijat armotta on erotettu puolueen yhteydestä ja leimattu mustimpaan porwaristoon kuuluwiksi.</p>
        <p>On täysin ymmärrettäwää, että puolueen nykyinen taktiikka ei ole woinut olla herättämättä arwostelua puolueen walistuneimpien ainesten keskuudessa, waikka siitä toistaiseksi on sangen 
          wähän julkisuudessa näkynyt. Siltasaarelaisjohtajien matruusiweljeily ja huligaaniainesten suosiskelu on tosiaankin ollut siksi wastenmielistä syrjäisellekin, että täytyy ihmetellä, että 
          sitä puolueen ajattelewimmat ainekset owat näinkin hiljaisuudessa sietäneet. Täydellä syyllä on kysytty, eikö puolueessa ole ainoatakaan miestä, joka puolueen nykyisten johtomiesten 
          menettelystä uskaltaisi totuuden lausua.</p>
        <p>Nyt on kuitenkin näkynyt muutamia walon wälähdyksiä, jotka osottawat, että arwostelu puolueen keskuudessa wihdoinkin on heräämässä. Kuten joku aika sitten Häm. Woiman mukaan kerroimme, 
          on maist. Timo Korpimaa, joka jo muutama wuosi sitten uskalsi ryhtyä puolueessa itsenäisesti ajattelemaan, ilmoittanut eronneensa sosialidemokraattisesta puolueesta, koska hän ei woi 
          hywäksyä puolueen anarkistista suuntaa. Myöhemmin julkaisemassaan selwityksessä kieltää maist. K. suinkaan hyljänneensä sosialismia, waikka onkin eronnut Suomen sosialidemokratisesta 
          puolueesta. Sosialismi on ulkopuolella mainittua puoluettakin, johon K. ei woi kuulua, koska hän ei mitenkään woi hywäksyä nykyistä siltasaarelaista menettelytapaa, jonka mukaan puolue 
          edelleen näyttää tanssiwan. Selitys päättyy toiwomukseen, että maahamme pian syntyisi uusi sosialistinen puolue, johon hänkin woisi liittyä.</p>
        <p>Yksi pääskynen ei kesää tee, mutta merkeistä päättäen ei tämä pääskynen tällä kertaa jää yksinäiseksi. Kuopiossa ilmestywässä „Sawon Työmiehessä” on pitkin syksyä ollut kirjoituksia, 
          jotka osottawat, että puolueen nykyisistä menettelytawoista on sielläpäin saatu tarpeeksi. Joku wiikko sitten julkaisi lehden entinen päätoimittaja ja sosialistinen kansanedustaja O. 
          Piisinen lehdessä kirjoituksia suojeluskuntain tarpeellisuudesta suhtautuen niissä erittäin ymmärtäwäisesti tähän nykyhetken tärkeään kysymykseen. Mainitun wäittelyn jälkeen julkaisi 
          samassa lehdessä nimimerkki R. T. joukon kirjoituksia arwostellen sangen ankarasti puolueen nykyistä taktiikkaa. Lehden päätoimittaja, sittemmin erotettu, „bolshewismin läpitunkema” 
          maisteri I. Kohonen koetti parhaansa mukaan pillastuneita asetella, siinä kuitenkaan, kuten luonnollista on, onnistumatta.</p>
        <p>Nykyään näyttää jälleen uusi myrskypilwi, olewan kohoamassa suomalaisen sosialismin itäiselle taiwaalle ja tällä kertaa entistä uhkaawampi. Tunnettu sosialistijohtaja T. Tainio, 
          joka nykyisin on „Sawon Työmiehen” päätöimittajana, on asettunut edellämainittujen arwostelijoiden kannalle. Julkaisemassaan kirjoitussarjassa „Waarojen keskellä” hän tekee selwäksi 
          syitä, jotka owat pakottaneet perustamaan suojeluskuntia ja teroittaa isänmaallisuuden welwoittawaa merkitystä keskellä sisäisten riitojenkin. Kun kirjoituksessa on ajatuksia, joiden 
          luulisi saattawan useammankin sosialistin harkitsemaan asemaa toiselta kannalta kuin Helsingin „Työmiehen” maaseutukaikuineen, julkaisemme siitä muutamia kohtia.</p>
        <p>Kirjoittaja johdattaa mieliin niitä pelottawia tapahtumia, jotka on sattunut Wenäjän läntisissä rajamaissa kun niitä on „tyhjennetty”, Kaikki on häwitetty ja poltettu, wiljat ja karjat 
          wiety, asukkaat jätetty nälkään nääntymään, jollei heitä ole ajettu kuin karjalaumaa pois kotiseuduiltaan kohti tuntemattomia kohtaloita. Paljoa parempi kohtalo ei meitäkään odottane, 
          luwattakoon ennakolta mitä tahansa, Wielä surullisemmaksi woi asema käydä ainakin joillakin alueilla, jos samallainen kurittomuus, wallattomuus ja ilkiwallanhalu säilyy wenäläisissä 
          sotajoukoissa, mikä nykyisin näyttää käyneen yleiseksi Etelä-Suomessa, missä näitä joukkoja kosommilta on. Ryöstöt, murhat, tihutyöt uhkaawat peräytymislinjojen asukkaita.</p>
        <p>Tämä kaikki on estettäwä. Se on estettäwä omin woimin, sillä mitään muuta turwaa tai apua ei meillä ole. Meillä täytyy olla woimia, järjestettyä woimaa, jos aijomme henkemme, naisemme 
          ja omaisuutemme koskemattomina säilyttää. Yksinomaan tieto siitä ettemme aio itseämme puolustamatta alistua jonkun hullaantuneen ryöwärijoukon mieliwalloin kohdeltawaksi, saattaa 
          kärsimyksiämme suuresti supistaa, ehkäpä suurimmaksi osaksi niistä pelastaakin.</p>
        <p>Ei ole kysymys kapinasta Wenäjää wastaan, siihen emme kykene, lausui kirjoittaja, mutta esiintyköön ryöwärinä wenäläinen tai suomalainen, niin meillä on oikeus itseämme ja omaisuuttamme 
          suojella. Luonnollista itsepuolustusoikeuttamme ryöstöjä, wäkiwallantöitä ja raiskauksia wastaan ei meiltä woida riistää. Kun ei hallitus woi tai ei tahdo meitä suojella, täytyy meidän 
          itse siihen kyetä. Toiwottawasti meillä on sen werran kuntoa ja miehuutta, että rohkenemme itseämme puolustaa, hätyyttää pois ryöwärit ja ihmispedot, jos ne kimppuumme käywät.</p>
        <p>Tässä on oikea pohja suojeluskaartikysymykselle.</p>
        <p>Selostettuaan suojeluskuntien syntyä ja esitettyään sen mielipiteen, että niillä on kaksinainen tarkoitus — edellämainittu sekä porwarillisten luokkaetujen suoja — kirjoittaja, wiitaten 
          työwäen järjestyskaartien muodostamiseen, lausuu että niidenkin tehtäwän tulisi olla kahdenlaisen: toiselta puolelta suojella ja puolustaa työwäestön luokkaetuja, sikäli kun asiat sille 
          kannalle kääntywät, että niitä wakawasti uhataan, ja toiselta puolelta myöskin järjestyksen, omaisuuden, wapauden ja hengen suojelemiseksi, missä ja milloin tahansa niitä uhataan, eikä 
          ainoastaan työwäen omaisuuden, wapauden ja hengen suojelemiseksi, waan myöskin porwarien. Se olkoon suoraan ja rehellisesti sanottu. Kansalaisten omaisuus, wapaus ja henki woiwat joutua 
          suureenkin waaraan ulkopuolisten woimain taholta ja silloin wasta suojeluskuntien kyky ja woima tulikoetukseen joutuukin. Yhdentekewätä on silloin, onko kysymys porwarien tai 
          sosialistien omaisuudesta ja hengestä. Kaikkien suomalaisten omaisuus on yhteistä kansallisomaisuutta, warsinkin meidän sosialistien kannalta, ja sellaisena sitä on suojeltawa 
          yhteiswoimin waikkakin ehkä eri joukoin. Me tarwitsemme kaiken wiljan, karjan, pellot, tawarat, mitä maassamme on ja sentähden niitä ei saa ryöstää, häwittää tai raiskata. Suomen 
          kansalle, sen käyttö- ja weroituspiiriin, kuuluu kaikki sekin omaisuus, mitä rikkaat porwarit tai kapitalistit hallitsewat ja sentähden sitäkin on suojattawa. Ja missä rikas menettää 
          osan omaisuuttaan siinä menettää köyhä kaikkensa, elämänsä ehdot, jos wielä työpaikatkin häwitetään. Eikä kyseessä ole ainoastaan omaisuus, waan myöskin wapautemme, henkemme, naistemme 
          kunnia. Kaikkia on suojeltawa samalla tawalla, jos ketään aiotaan pelastaa.</p>
        <p>Keskellä sisäisten riitojen, kiihkeimmänkin taistelun aikana, meidän täytyy muistaa, olewamme suomalaisia ja tietää se, ettei meitä kukaan toinen suojele, jollemme itse siihen pysty.</p>
        <p>Toiwottawaa on, että nämä selwän järjen sanat saawuttawat wastakaikua myöskin Hämeessä.</p>
      </Article>

      <div className="interTitle">10.11.1917</div>
      <Article titleText="Wäkiwallanteot Mommilassa.">
        <p>Eri lähteiden mukaan koetamme seuraawassa yhtenäisesti kuwata Mommilassa sattuneita järkyttäwiä tapahtumia.</p>
        <p>Pikajuna, jossa matruusit saapuiwat Mommilan pysäkille, pysähtyi klo 3,10 ip. Junasta astui 26 matruusia. Klo 6 aikaan illalla tuli paikalle automobiilillä lisää 4 matruusia, jotka 
          oliwat lähteneet Helsingistä klo 4 päiwällä. Junassakin saapuneet matruusit owat todennäköisesti lähteneet matkalle Helsingistä eikä Turusta, kuten ensiksi otaksuttiin.</p>
        <p>Matruusit pysytteliwät iltaan asti pysäkillä häiritsemättä ketään. Klo 7 aikaan illalla saapuiwat matruusit pysäkin lähellä sijaitsewaan kauppias Wäinö Nokkalan asuntoon pyytäen 
          ruokaa, jonka he jälkeenpäin maksaisiwat. Syötyään ja juotuaan teensä he pyysiwät yösijaa. Isännän walitellessa tilojen ahtautta ja kysyttäessä syytä matruusien oloon paikkakunnalla, 
          wastasiwat nämä: „Me waan wahdimme tämän yön täällä. Eikä tässä ole niin nukkumisesta wäliä. Olemme laiwoillamme saaneet nukkua tarpeeksemme”.</p>
        <p>Matruusien pyyntöön suostuttiin lopulta, jolloin he sijoittautuiwat talon keittiöön, wiettäen siellä yönsä, keittäen ja juoden teetä, korttia pelaten ja keskustellen.</p>
        <p>Matruusien joukossa oli 2 suomea puhuwaa miestä, joista toinen oli paikkakunnalla ennestään tunnettu, <span className="accent">suutari Johan Skott</span>, joka hänkin oli matruusin 
          puwussa ja joka paikkakunnalla arwellaan koko retkeen syypääksi. Aikaisemmin hän on asunut Mommilan kartanon rajamailla ja ollut maanwiljelysneuwos Kordelinin palweluksessa. Kun hän 
          wietti huonoa elämää m. m. myyskennellen wiinaa, erotti maanwiljelysneuwos Kordelini hänet palweluksestaan. Tämän jälkeen on Skott, jonka warsinainen ammatti on suutarintyö, ollut 
          Wenäjän waltion wallitöissä, jatkaen hurjaa elämäänsä. Nyt katsoi hän sopiwan hetken kostaa isännälleen.</p>
        <p>Klo 6 aamulla lähtiwät matruusi liikkeelle mennen osittain jalkaisin, osittain automobiilillä n. 10 km:n päässä olewaan maanwiljelysneuwos Alfred Kordelinin omistamaan Mommilan 
          kartanoon, jonka he piirittiwät. Klo 7:ään asti aamulla pääsi wielä kartanosta muun maailman yhteyteen puhelimitse, mutta ei sen jälkeen enää, sillä matruusit katkaisiwat molemmat 
          kartanosta johtawat puhelinlangat, joista toinen wie Kärkölään ja toinen Oitin keskusasemalle.</p>
        <p>Kartanon lähelle tultua jättiwät matruusit auton jonkun matkan päähän lähtien jalan kartanoa kohden. Saawuttuaan perille piirittiwät he päärakennuksen. Mikäli kerrotaan laskettiin 
          sotilaat isännän käskystä sowinnolla sisälle, jonka nämä tekiwätkin asettaen sitä ennen kiwäärinsä pihamaalle kehikkoon. Toisten tietojen mukaan meniwät matruusit sisälle 
          wäkiwaltaisesti rikkoen owet.</p>
        <p>Matruusit sisälle päästyään julistiwat kaikki sisälläolijat wangituiksi. Kartanon konttorin owi murskattiin samoin kuin useita akkunoita, jonka jälkeen wäkiwallantyöntekijät paniwat 
          toimeen perusteellisen kotitarkastuksen, jolloin he saiwat saaliikseen kymmenkunta kiwääriä ja haulikkoa sekä suuren joukon arwoesineitä, kuten kelloja, sormuksia, rannerenkaita, 
          hopeaisia pikareita y. m. Myöskin waatetawaraa otettiin suuri joukko. Talon etikka y. m. pullot tutkittiin tarkoin.</p>
        <p>Mellastelun aikana oli kartanossa paitsi Mommilan kartanon omistajaa, maanwiljelysneuwos Kordelinia itseään, sinne hänen syntymäpäiwäwieraikseen saapuneita henkilöitä yhteensä 22, 
          niiden joukossa lakit. kand. warat. R. Ryti rouwineen Helsingistä, hra Kordelinin sisarentytär Thyra Wahnlund Helsingistä, hra Kordelinin weli kauppias I. Waltonen Raumalta, 
          merikapteeni G. W. Wass Raumalta, Jokkis Gods A. B:n isännöitsijä P. Pettersson rouwineen, Jokioisten sokeri- ja siirappitehtaan toimeenpanewa johtaja, ins. W. Norrman, tirehtööri Hj. 
          Björk sekä asemapäällikkö Hj. Allen rouwineen, kaikki Jokioisista, jotka kaikki tuliwat wangituksi.</p>
        <p>Klo 12—1 tienoissa päiwällä lähdettiin kuljettamaan wangituita Mommilan pysäkille päin. Edellä kulki matruusien automobiili, jossa paitsi kuljettajaa, oli 4 matruusia ja näiden jäljestä 
          wangitut hewosten wetämissä ajoneuwoissa, sekä toinen matruusien automobiili.</p>
        <p>Tällä wälin oli Lahdesta pyydetty sähköteitse apua. Aamupäiwällä lähtikin Lahdesta ylimääräinen juna, jossa oli nelisenkymmentä suojeluskuntalaista Lahden uuden poliisimestarin J. 
          Tammisen johdolla. Saawuttuaan Mommilan pysäkille, lähti apujoukko pikamarssissa kartanoon päin luutnantti Tamminen hewosella ajaessa joukon etunenässä.</p>
        <p>Noin kolmen ja puolen kilometrin päähän Mommilan pysäkiltä tultuaan saapuiwat wapaaehtoiset paikkaan, jonka kuwaus on seuraawa:</p>
        <p>Maantien wasemmalla puolen on awoin pelto; oikealla on harwaa näreikköä, mutta loitommalla wankempaa metsää. Edessä alkaa myös metsäinen taiwal. Tässä metsän reunassa maantien laidassa 
          on mäkituparakennuksia. Tällä paikalla tapahtui taistelu.</p>
        <p> Luutnantti Tamminen, joka ajoi edellä hewosella noin kilometrin werran, palasi takaisin wakawana. Hän ennätti warottaa miehistöään, ettei se saa ampua laukaustakaan ennen kuin hän 
          määrää, mikä oli myös kaikkien yhteinen mielipide, kun samassa maantien mutkasta tuli näkywiin noin 50 metrin päässä auto, joka oli täynnä merisotilaita. Luutnantti Tamminen pyysi 
          tällöin kohteliaasti seisauttamaan auton. Merisotilaat ojensiwat tällöin heti pistoolit ja kiwäärit wapaaehtoisia kohti ja ampuiwat yhteislaukauksen josta kuitenkaan kukaan ei 
          haawoittunut. Tämän jälkeen luutn. Tamminen komensi joukkonsa hieman peräytymään taaksepäin ja ampumaan, alkaen samalla myös itse tulen. Näissä asemissa jäiwät suomalaiset awonaiselle 
          pellolle, jota wastoin merisotilaat heti hyppäsiwät autostaan ja juoksiwat metsään, jossa awasiwat hywin kiihkeän tulen kiwien ja mäkituparakennusten takaa. Kiiwasta ammuntaa kesti 10 
          minuuttia, kun wenäläiset saiwat apua. Tuli kiihtyi ja samalla alkoiwat wenäläiset saartaa suomalaisten sekä wasenta, että oikeaa siwustaa.</p>
        <p>Oikealle siwustalle tehty kiertoliike saatiin pian torjutuksi niin että saartajat pakeniwat tiheikköön, jota wastoin wasemmanpuolinen saartoliike onnistui siinä määrin, että pitkin 
          peltosarkoja sotilaat ampuiwat noin 150 metrin päästä, mutta on hywin luultawaa, ettei tässä ristititulessa ainoakaan kaatunut tai haawoittunut.</p>
        <p>Taistelun kuluessa ammuttiin waunuissa olewaa herra <span className="accent">Kordelinia</span> ohimosta sisään ja kuoli hän siihen paikkaan. Ampuja oli hywin luultawasti suutari Skott. 
          Samoin ammuttiin Jokioisten kartanon isännöitsijä hra <span className="accent">Pettersson</span> sekä toinen hewosista.</p>
        <p>Ammuntaa jatkui noin 30 -40 minuuttia ja sen päätyttyä löydettiin taistelukentältä walokuwaaja <span className="accent">Uuno Berglund</span> Lahdesta ja 
          metsänhoitaja <span className="accent">Koiwistoinen</span> Lahdesta sekä pari wenäläistä kuolleina. Hywin pahasti haawoittuneena tawattiin myöhemmin taistelupaikan lähistöltä erään mökin 
          ulkohuonerakennukseen piiloutuneena yllyttäjä <span className="accent">Skott</span> merisotilaan pukuun puettuna. Skottin tapasi eräs suojelusosastolainen Lahdesta sekä pari lääkäriä. 
          Suojeluskuntalaiset toiwat hänet junassa Lahteen, missä häntä hoidetaan kunnallissairaalassa. Hän woi werrattain hywin. Häneltä on jalka katkennut ja rinnassa on hänellä pari luotia. 
          Myös sääreen on hänelle sattunut kuula.</p>
        <p>Lahden kunnallissairaalassa kysyttäessä hänen nimeään ja ammattiaan sanoi hän olewansa „Juuhan Skott” ja olewansa „merisotilaana siinä wenäläisessä keisarillisessa huwijahdissa, joka 
          on Helsingin lähistössä”.</p>
        <p>Taistelupaikalta maantienojasta löydettiin myöskin kaksi surmansa saanutta matruusia.</p>
        <p>Taistelu päättyi siten, että kun ristituli alkoi, oli suomalaisten pakko hakea suojaa metsästä, kiwistä y. m. Tällöin pääsi jokunen merisotilas autoilla ja hewosilla pakenemaan ja osa 
          heistä pakeni metsään ja samoili siellä.</p>
        <p>Taistelupaikalta palasiwat ensimäiset matruusit klo 3 aikaan ip. Mommilan pysäkille ja oli heitä 11—18 miestä, jotka junaan n:o 9 nousten palasiwat Helsinkiin päin. Yksi heistä oli 
          haawoittunut siten, että oli ammuttu jalka läpi. Matruusit käwiwät tällöin myöskin kauppias Nokkalalla maksamassa laskunsa. Toinen joukko matruuseja, 6 miestä, saapui n. puolitoista 
          tuntia myöhemmin Mommilaan ja jatkoiwat nämä jalkaisin matkaansa Oittiin.</p>
        <h5>Uudenmaan lääninhallitus ilmoittaa sotilaskomitealle aiotusta ryöstöretkestä.</h5>
        <p>Jo tiistaina ilmoitettiin Uudenmaan lääninhallitukseen, että joukko wenäläisiä merisotilaita on menossa Mommilaan ryöstämään ja häiriötä tekemään. Lääninhallituksesta ilmoitettiin 
          asiasta silloin heti Helsingin toimeenpanewalle komitealle, että sotilaita on sellaisella matkalla ja pyydettiin komiteaa estämään se.</p>
        <p>Ilmoitus ei kuitenkaan antanut aihetta komitean puolelta mihinkään toimenpiteisiin. Tämän johdosta ja kun saatiin warmempia tietoja siitä mitä oli tapahtumaisillaan, tehtiin 
          lääninhallituksesta toinen ilmoitus toimeenpanewalle komitealle. Tällöin neuwottiin toimeenpanewasta komiteasta lääninhallitusta kääntymään Helsingin satamassa seisowalla „Poljarnaja 
          Swjesda” -nimisellä laiwalla olewan meriwäen toimeenpanewan komitean puoleen. Kun ratsumestari Gustafsson kääntyi tämän puoleen ilmoittamalla, että Mommilassa on meriwäkeä, joka ryöstää, 
          lupasi komitea hywin epämääräisesti mahdollisesti lähettäwänsä parikymmentä miestä klo 6,50 ip. lähtewässä junassa.</p>
        <h5>Helsingistä apua.</h5>
        <p>Kun lupaus oli näin häilywä, ei Uudenmaan läänin kuwernööri katsonut woiwansa jättää asiaa sikseen, waan ryhtyi hän toimenpiteisiin wapaaehtoisen awun saamiseksi. Klo 4 ip. lähtikin 
          Helsingistä ylimääräinen juna, joka wei joukon wapaaehtoisia järjestysmiehiä ottamaan asiasta lähempää selkoa ja suojelemaan ryöstön ja wäkiwallan uhreiksi joutuneita. Parista muustakin 
          kartanosta samalla paikkakunnalla oli ilmoitettu, että huhutaan ryöstäjäin siirtywän niihin wäkiwaltaansa harjoittamaan.</p>
        <p>Juna, joka m. m. Riihimäen siwuutti täydellä wauhdilla, saapui Oittiin klo 7:n ajoissa illalla, jolloin jo wallitsi pimeys. Juna pysäytettiin wähää ennen asemaa, jolloin wapaaehtoiset 
          astuiwat junasta ja lähtiwät astumaan asemalle päin, joka oli walaistu. Asemalla oli kuusi sotilasta, joista 5 meri- ja 1 maasotilas. He awasiwat heti tulen suomalaisia wapaaehtoisia 
          wastaan ja lähtiwät sitte käpälämäkeen. Tällöin haawoittui helsinkiläisistä yksi. Suomalaiset wastasiwat ammuntaan tulella, josta oli seurauksena, että eräs pistimellä ja 
          berdaani-kiwäärillä warustettu suomalaisia ampunut maasotilas kaatui hengetönnä asemasillalle.</p>
        <h5>Wankien kohtalo.</h5>
        <p>Ojakkalasta ilmoitetaan, että matruusien käsistä pelastunut rouwa Mansner nyttemmin on saapunut kotiin. Yhdessä rouwa Petterssonin kanssa oli hän kahakan aikana päässyt pakenemaan. He 
          oliwat menneet Mommilan kartanoon. Sieltä oliwat matruusit ottaneet kaikki ajopelit, mutta naiset ajoiwat heinärattailla erääseen Mommilan ulkokartanoon wieden matkarahat mukanaan. Sen 
          jälkeen he wielä palasiwat takaisin Mommilaan, jonne silloin juuri tuotiin Petterssonin ja Kordelinin ruumiit. Samalla alkoi kuulua ankaraa ammuntaa jonkun matkan päässä Mommilasta. 
          Rouwa Mansner seuralaisineen lähti tällöin takaisin ulkokartanolle, mistä yöllä saatuaan kyydin pääsiwät Turenkiin. Miehensä kohtalosta ei rwa M. tiedä mitään. Tilanhoitaja Forsell oli 
          naisten käydessä Mommilassa saapunut sinne. Hänen otsassaan silmän yläpuolella oli ammottawa haawa, jonka kuula oli wiiltänyt.</p>
        <h5>Kordelinin murhaaja.</h5>
        <p>Lahdesta on saatu tieto, että Mommilassa wenäläisten retkellä mukana ollut suutari Skott, sikäli kun asiasta on tähän saakka saatu selkoa, on maanwiljelysneuwos Kordelinin murhaaja. 
          Kahakan syntyessä oli Skott kiroten ampunut uhrinsa ja lisännyt: „Ainakaan lahtareille sinua ei anneta.”</p>
        <h5>Luutnantti Tammisen ilmoitus.</h5>
        <p>Lahden poliisimestari luutnantti Tamminen on pyytänyt ilmoittamaan, ettei hän ollut Mommilassa suojeluskunnan jäsenenä, waan oli saapunut sinne kuwernöörin määräyksestä ottamaan 
          selwää tapahtumista. Hän yritti kääntyä sotilaiden puoleen saadaksensa selwille missä tarkoituksessa he oliwat tulleet ja muutenkin järjestääkseen asiaa. Hänen rauhalliseen 
          tiedusteluunsa wastasiwat sotilaat ampumalla, jolloin suojeluskuntalaisetkin häntä puolustaakseen awasiwat tulen.</p>
        <h5>Postijunan pysäyttäminen Mommilassa.</h5>
        <p>Niinkuin wiime numerossamme kerrottiin, pysäytettiin pikajuna Mommilan pysäkillä, jossa merisotilaat nousiwat junasta. Mikäli U. S. on asian omaiselta taholta saanut tietää, tapahtui 
          junan pysäyttäminen wenäläisen sotilaskuljetuspäällikön rautatien sotilaskuljetuskonttorille antaman määräyksen perusteella. Pysähtymisellä ilmoitettiin olewan sotilaallinen tarkoitus.</p>
        <h5>Riihimäellä olewa wirolainen sotawäki.</h5>
        <p>Riihimäellä oli siellä oleskelewan sotawäen keskuudssa kiihoitettu lähetettäwäksi osasto Mommilaan, mutta kieltäytyiwät wirolaiset sotamiehet osaaottamasta tähän.</p>
        <p>Riihimäellä ampuiwat kaiken aikaa siellä hälisewät sotilaat toissayönä klo 12 erästä inwalidijunaa, joka oli matkalla Wenäjältä pohjoiseen, mukanaan sotawankeja — inwalideja heidän 
          waihtoaan warten — ja joka seisoi Riihimäen asemalla 40 min.</p>
        <p>Kukaan ei haawoittunut matkustajista.</p>
        <h5>Wenäläistä sotawäkeä saapuu.</h5>
        <p>Yöllä wiime torstaita wastaan saapui Mommilan pysäkille wenäläistä sotawäkeä kaikkiaan n. 400 miestä. Sotilaat oliwat jalkawäkeä ja saapuneet luultawasti Helsingistä. Heidän 
          tehtäwänään oli nähtäwästi järjestyksen palauttaminen. Osa heistä jäi Mommilan pysäkille ottaen puhelimen ja sähkölennättimen haltuunsa. Suurin osa lähti Mommilan kartanoon. 
          Puhelinyhteys kartanoon oli edelleen katkaistuna. Torstai-aamuna wallitsi paikkakunnalla täydellinen rauha, waikka asukkaiden mieliala tapahtumien johdosta oli lewoton.</p>
      </Article>
      <Article titleText="Helsingin toimeenpanewa komitea ja Mommilan tapahtumat.">
        <h5>„Me tulemme kaikin keinoin estämään Suomen porwariston asestautumisen”.</h5>
        <p>H. S. on puhelimitse keskustellut Helsingin toimeenpanewan komitean puheenjohtajan Scheinmannin kanssa, joka ilmoitti kysymykseen neuwoston toimeenpanewan komitean suhtautumisesta 
          Mommilan tapahtumiin seuraawaa:</p>
        <p className="quote">Mommilan tapahtumista, ja meidän suhtautumisestamme niihin ei minulla ole muuta sanottawaa kuin, että me tulemme kaikin keinoin estämään Suomen porwariston 
          asestautumisen. Kysymys ei tässä tapauksessa ole niin paljon muutaman matruusin kuolemasta kuin siitä, että meidän on päästäwä tämän tarkoituksemme perille. Meidän on etsittäwä 
          porwariston asewarastot ja riisuttawa porwaristo aseista. Jos tämä toimenpide tulee kohtaamaan esteitä, niin <span className="accent">julistamme Suomen sotatilaan.</span></p>
        <p>Kysyttäessä erikoisesti tapahtumain kulusta Mommilassa wastasi Scheinmann:</p>
        <p className="quote">Kohtaus Mommilassa ei tällä hetkellä (klo 8,30 illalla) ole wielä selwitetty, mutta se selwitetään epäilemättä hengessä, joka wastaa yleistä waltiollista asemaa ja 
          meidän suhdettamme siihen.</p>
        <p>S. T. T. ilmoitti keskiwiikkona päiwällä, ennenkuin wielä oli tullut tietoa weritöistä:</p>
        <p>Toimeenpanewassa komiteassa sanotaan wangitsemisesta kyllä tiedettäwän ja ilmoitetaan että wangitut tuodaan Helsinkiin, jossa heidät kaikki tullaan tutkimaan ja ettei „heille tulla 
          tekemään mitään pahaa”.</p>
      </Article>

      <div className="interTitle">13.11.1917</div>
      <Article titleText="Sosialistien vallankumoussuunnitelmat.">
        <h5>Täydellinen suunnitelma walmiina heti toteutettawaksi.</h5>
        <p>Lauantaina illalla Helsingissä pidetyissä työwäen kokouksissa annettiin seuraawa julistus:</p>
        <p>Eduskunnan lauantaisessa istunnossa annetaan sos. dem. eduskuntaryhmän puolesta porwaristolle wiimeinen waroitus ja kehoitetaan heitä luopumaan wallananastuspolitiikastaan ja 
          julkaisemaan woimaan heinäk. 18 p. laki. Elleiwät he sitä hywäksy tullaan nykyinen eduskunta poistamaan ja tilalle asettamaan Suomen laillinen eduskunta, joka kokoontuisi ensi 
          tiistaina.</p>
        <p>Kaikille sos. dem. piiritoimikunnille maassa on annettu määräys ryhtyä toimenpiteisiin työwäenkokokouksien koollekutsumiseksi, joissa keskustellaan ja päätetään nykyisestä asemasta. 
          Samalla muodostetaan kaikkiin kuntiin wallankumouksellisen keskustoimiston alaisia työwäen kunnallisneuwostoja, jotka tulewat toimimaan keskusjärjestön ohjeitten mukaan.</p>
      </Article>

      <div className="interTitle">20.11.1917</div>
      <Article titleText="Sosialistien wallankaappaus.">
        <h5>Eduskunta.</h5>
        <p>Eduskunnan wiime tiistaisessa istunnossa esittiwät sosialistit jälleen itsepintaiset waatimuksensa „Me waadimme” ohjelmansa hywäksymiseksi. Eduskuntajärjestykseen wedoten puhemies 
          kieltäytyi kuitenkin ottamasta asiaa käsiteltäwäksi. Seurauksena oli, että sosialistit julistiwat suurlakon, joka alkoi keskiwiikon wastaisena yönä klo 12, woidakseen sen awulla 
          wäkiwallalla saada waatimuksensa läpiajetuiksi.</p>
        <p>Keskiwiikkona oli eduskunnalla jälleen istunto, jossa ei päästy yksimielisyyteen. Torstaisessa istunnossa teki ed. Alkio wälitysehdotuksen korkeimman wallan käyttöä koskewaan lakiin, 
          joka äänestyksen jälkeen hywäksyttiin. Samaten hywäksyttiin kunnallislait ja 8 tunnin työpäiwälaki. Senaatti ilmoitti tällöin jättäwänsä paikkansa kehoittaen eduskuntaa toimiin uuden 
          muodostamiseksi. Sosialistit eiwät kuitenkaan waatimuksiin tyytyneet waan päättiwät lakkoa jatkaa. Lauantaina piti eduskunnan jälleen kokoontua, mutta kokoontumisesta ei tullut mitään 
          kun punakaartilaiset oliwat päiwällä mellastaneet wallaten m. m. senaatin ja muita julkisia rakennuksia. Sunnuntaina ilmestyi eduskunnan istuntohuoneuston owelle julistus, jossa 
          puhemies ilmoitti, että eduskuntaa ei tulla kutsumaan kokoon ennenkuin lakko on päättynyt. Samalla katkaisiwat porwarilliset puolueet, joukossa maalaisliittokin, kokonaan wälinsä 
          sosialistien kanssa. Yksityisten ryhmien kesken lienee wielä neuwotteluja jatkettu.</p>
        <p>Myöhemmin ilmoitettiin, että sosialistit oliwat muodostaneet puhtaan punaisen senaatin.</p>
        <p>Senaattoreiksi on walittu: O. Tokoi, Yrjö Mäkelin, W. Jokinen, Yrjö Sirola, E. Gylling, I. Mäki, Sulo Wuolijoki, I. Lumiwuokko, K. Lindqwist, ja Julius Ailio. Warmuutta ei ole, onko 
          eduskunta hywäksynyt tämän waalin.</p>
        <p>Ylläolewat tiedot eiwät ole tarkistettuja.</p>
      </Article>
      <Article titleText="Sosialistien wallankaappaus.">
        <p>Wiime päiwien järkyttäwät tapahtumat owat osoittaneet, että sosialistimme wallantawottelussaan eiwät ole häikäilleet ryhtyä keinoon, jolla saattaa olla mitä wakawimmat seuraukset. 
          Wieraan wallan pistimien suojassa, wieraalta saatu ase kädessä, lainalaisen yhteiskunnan ulkopuolelle asettuen he owat yrittäneet kaapata itselleen wallan, ja siinä jossain määrin 
          onnistuneetkin. Kansalaismurhat, laittomat kotitarkastukset, kansalaisten laittomat wangitsemiset, kaikki mahdolliset kansalaiswapauden loukkaukset, maan kawalluksen luontoiset 
          ilmiannot, ryöstöt ja wäkiwallanteot, walhe ja wääristely owat reunustaneet sitä tietä, jota sosialistimme näinä päiwinä owat kulkeneet. Sana- ja lausuntowapaus oli poljettu lokaan. 
          Yksilön henki ja omaisuus owat olleet alituisessa waarassa. Sanalla sanoen wihatun tsaariwaltiuden pimeimpinäkään aikoina eiwät wapaan Suomen kansalaisen oikeudet koskaan olleet siinä 
          määrin kaikenlaisten loukkausten alaisina, kuin näinä siltasaarelaisten sosialistien hirmuhallituksen päiwinä.</p>
        <p>Porwarillisten puolueiden äärimmäinen maltillisuus ja tawaton pitkämielisyys pelastiwat kansamme tällä kertaa werisestä kansalaissodasta ja lopullisesta perikadosta. Wäkiwaltaan ei 
          wastattu wäkiwallalla. Seurauksena oli, että sosialistit nyt owat muodostaneet puhtaan punaisen hallituksen. Toiminnassaan tämä nähtäwästi tulee nojautumaan Wenäjän bolhsewikiwaltaan 
          ja punakaartien kiwääreihin, sillä eduskunnan ehdoton enemmistöhän on porwarillinen. Pitkäaikaiseksi ei tällainen wähemmistön pistimiin nojautuwa luokkawalta saata tulla, mutta senkin 
          ajan, jonka se on wallassa, tulee se todennäköisesti käyttämään saattaakseen maan täydellisen sekasorron tilaan. Olemme wiime päiwät sosialistien äärimmäisyyksiin menewän walonarkuuden 
          wuoksi olleet siinä määrin eristetyt muusta maailmasta, että emme wielä täysin tunne tilannetta emmekä saata lausua lopullista arwosteluamme tapahtuneesta. Mutta sekin, minkä me 
          tiedämme, ei hywää ennusta.</p>
      </Article>
      <Article titleText="Suurlakkopäiwät Hämeenlinnassa.">
        <h5>Sosialistit kansalaiswapautta loukkaamassa.</h5>
        <p>Tieto suurlakon julistamisesta saapui Hämeenlinnan työwäenjärjestöille keskiwiikon wastaisena yönä. Aamulla lewitettiin jo painettua julistusta ja useat työläiset jäiwät pois töistä. 
          Niinpä joutuiwat täkäläiset kirjapainot seisomaan aamusta alkaen. Samaten paitatehdas. Werkatehtaalle saapui työwäki aamulla, päiwällisistä jäi kuitenkin osa pois, joten pidettiin 
          parhaimpana lopettaa työt kokonaan seuraawasta aamusta. Myöskin wanutehtaalla oli työwäki töissä ensimäisen lakkopäiwän.</p>
        <p>Keskiwiikkona aamuna pidettiin Palokunnantalolla työwäen kokous, jossa päätettiin lakkoon yhtyä. Tarkotuksena oli saada lakkoon yhtymään myöskin kauppaliikkeet, puhelinlaitos ja 
          rautatiet. Keskiwiikkona käwiwätkin täällä muodostetun suurlakkokomitean lähetystöt eri liikkeissä esittämässä, että kaupat suljettaisiin. Aniharwat liikkeet suostuiwat tähän, useimmat 
          taasen lain turwaamaan elinkeinowapauteen nojaten kieltäytyiwät kehotusta noudattamasta. Myöskin järjestyksen ylläpitoon alkoiwat sosialistit sekaantua. Aamulla saapui heidän edustajansa 
          w. t. poliisimestarin luo ilmottaen, että täkäläinen järjestyskaarti eli n. s. punakaarti ryhtyy ylläpitämään järjestystä yhdessä miliisin kanssa. Poliisimestari ilmoitti tämän täysin 
          tarpeettomaksi, koska järjestystä ei mikään uhkaa. Samalla hän kääntyi läänin kuwernöörin puoleen pyytäen tätä estämään järjestyksen hoitoa kohtaawa loukkaus. Kuwernööristä ei kuitenkaan 
          ollut mitään apua, päinwastoin hän heti erittäin puolueellisesti ja wailla läänin korkeimmalta wirkamieheltä waadittawaa harkintaa asettui täysin kannattamaan lakkolaisten pyyteitä. 
          Päiwällä saapuikin wartiokonttoriin muutamia lakkolaisia. Samaten ilmestyi kadulle miliisien wierelle pari punakaartilaista. Puhelinlaitos sai lakkolaisilta olla rauhassa aina iltaan 
          asti, jolloin heidän „kaartilaisiaan” saapui keskiöön, kieltäen sen henkilökuntaa wälittämästä puheluja muihin kuin heidän omiin numeroihinsa. Rautatieliikenne oli käynnissä koko päiwän. 
          Myöskin kouluja lakkolaiset waatiwat sulettawiksi, mutta tuloksetta. Koulut toimiwat koko lakkoajan, samoin myöskin posti niissä rajoissa kuin oli mahdollista.</p>
        <p>Torstaina aamulla esiintyi kaduilla n. 50-miehinen punakaartilaisjoukkue käyden eri liikkeissä waatimassa niitä suljettawaksi. Jotkut liikkeet suostuiwatkin, mutta useimmat jälleen 
          kieltäytyiwät. Puhelinasemalta poistettiin siellä wetelehtineet lakkowahdit, joten puhelu kaupungissa saatiin wapaaksi, ulkolinjat sitäwastoin oliwat suljettuina. Järjestyswallan 
          tehtäwiin alkoiwat lakkolaiset yhä enemmän sekaantua, lähettäen urkkijansa yksin poliisimestarin wirkahuoneeseen. Päiwällä piti Puhelin-yhtiö kokouksen, jossa pohdittiin, mihin 
          toimenpiteisiin olisi ryhdyttäwä yhtiön omaisuutta kohdanneen wäkiwallan johdosta. Päätettiin kääntyä kuwernöörin puoleen, jonka welwollisuutena korkeimpana järjestyksen walwojana on 
          pitää huolta, ettei yksityisen omistusoikeutta loukata. Iltapäiwällä liikkui kaduilla jälleen punakaartilaisjoukkue, joukossa erittäin epäilyttäwiä aineksia, liikkeitä sulkemassa. Heidän 
          esiintymisensä oli nyt paljon jyrkempää kuin tähän asti, uhkauksia ei säästetty eikä suoranaista wäkiwaltaakaan kartettu. Useat liikkeet sulkiwat nyt owensa, toiset suljettiin törkeällä 
          wäkiwallalla ja owille asetettiin wahdit. Jotkut näistä esiintyiwät siksi loukkaawasti, että paikalle kerääntynyt wäkiwallan johdosta kiihtynyt wäkijoukko pakotti ne poistumaan. Muutamat 
          liikkeet m.m. kaupungin molemmat kirjakaupat eiwät suostuneet sulkemaan uhkauksista huolimatta. Rautatieliikenne oli miltei kokonaan pysähdyksissä. Wain yksi matkustajajuna kumpaankin 
          suuntaan ja elintarwejunat saiwat kulkea. Matkustaa sai wain työwäen lakkokomitean antamalla lupalipulla.</p>
        <p>Perjantaina aamulla oli liikkeellä jälleen punakaartijoukkue, joka nyt oli saanut apua myöskin maaseudulta. Aikomus oli nähtäwästi nyt sulkea liikkeet keinolla millä tahansa. Klo 9 
          aikaan saapui joukkue Skogsterin liikkeen edustalle asettuen „rintamaan” wastakkaiselle katuwierelle. Sisälle meni nyt wankka lähetystö waatien jyrkästi liikettä suljettawaksi. Kun tähän 
          ei suostuttu, ryntäsi sisälle wiitisenkymmentä punakaartilaista ryhtyen wäkiwallalla estämään kaupantekoa ja poistamaan myyjiä. M. m. käyttiwät „kaartilaiset” wäkiwaltaa erästä Ruotsin 
          alamaista kohtaan. Paikalle kutsuttiin myöskin läänin kuwernööri, joka sensijaan että olisi kehoittanut wäkiwallantekijöitä poistumaan, ryhtyi heidän waatimuksiaan kannattamaan. Paikalle 
          kerääntyi myöskin lukuisa wäkijoukko, joka ilmaisi paheksumisensa tapahtuneen wäkiwallan johdosta. Kun selkkaus ei näyttänyt selwiäwän, meni punakaartin johtaja lakkokomitealta saamaan 
          lähempiä ohjeita. Palattuansa hän ilmoitti, etteiwät lakkolaiset aio enään wäkiwaltaa käyttää, waan tyytywät „siweellisiin keinoihin”. Tämän jälkeen „kaarti” poistui ja wäkijoukko 
          rauhallisesti hajaantui.</p>
        <p>Täkäläinen lakkokomitea julkaisi tapauksesta wahwasti wäritetyn kuwauksen, wäittäen, että paikalla olisi ollut suojeluskuntalaisiakin, jotka aseitaan näytellen, nilwien ja irwistellen 
          koettiwat ärsyttää punakaartin kimppuun, aiheuttaakseen siten werenwuodatuksen. Tämä on kuitenkin pelkkää mielikuwituksen tuotetta. Suojeluskunnalla ei ole tapahtumassa mitään 
          osallisuutta yhtä wähän kuin että aseita olisi puolelta tai toiselta näytelty.</p>
        <p>Heti tapahtuman jälkeen saapui läänin kuwernööri poliisilaitokseen ilmoittaen itse ryhtywänsä hoitamaan poliisimestarin tehtäwiä. Aamulla saapui puhelinasemalle jälleen lakkolaisia, 
          estäen wapaan puhelimen käytön. Seurauksena tällöin oli että puhelinlaitoksen henkilökunta poistui kokonaan asemalta, joka suljettiin muilta paitsi sotilailta. Lakkokomiteakin menetti 
          tällöin wapaan puhelimen käyttönsä.</p>
        <p>Klo 10 ap. oli torilla lakkolaisten „woittojuhla” sen johdosta, että eduskunta edellisenä iltana muka oli hywäksynyt sosialistien n. s. waltalain, 8-tunnin työpäiwälain ja kunnallislait. 
          Wäkeä oli saapuwilla wähänlaisesti.</p>
        <p>Muuten sujui lakko tästä alkaen, kun punakaarti, ei enään järjestystä häirinnyt, yleensä rauhallisesti. Kauppaliikkeet oliwat auki kuten tawallista.</p>
        <p>Lauantaina muutti lakkokomitea nimensä Työwäen wallankumouskomiteaksi. Se julkaisi päiwittäin tiedonantoja wahwasti wäittäen ne tarkotustensa mukaisiksi. Arwostelewat äänet oliwat 
          tukahutetut kirjaltajalakon wuoksi. Tämän wuoksi kaupunginwaltuusto ryhtyi toimenpiteisiin luotettawien tietojen hankkimiseksi kaupunkilaisille. Se perusti erityisen 
          tiedonwälitystoimiston, joka tawattoman waikeissa oloissa toimien julkaisi 3 tiedonantolehtistä.</p>
        <p>Lauantaina klo ½6 poistuiwat täkäläiseltä rautatieasemalta wirkailijat, ilmoittaen syyksi olewansa estetyt noudattamasta rautatiehallituksen määräyksiä. Sunnuntaina palasi kuitenkin osa 
          wirkailijoista takaisin.</p>
        <p>Sunnuntai kului kaikin puolin rauhallisesti.</p>
        <p>Maanantaina pidättiwät punakaartilaiset muutamia torille aikowia maalaiskuormia nähtäwästi etsien aseita.</p>
        <p>Aamulla waltasiwat punakaartilaiset läänin kuwernöörin suosiollisella awustuksella poliisilaitoksen kokonaan. Poliisimestariksi ilmoitti kuwernööri määränneensä konttoriapul. P. Jokisen, 
          joka samalla olisi poliisilaitoksen sihteeri. Kansliahenkilökunta poistui tällöin toimestaan. Entisen w.t. sihteerin H. Blåfieldin waati kuwernööri eroamaan, mihin tämä ei kuitenkaan 
          suostunut, waan ilmoitti wastalauseensa kuwernöörin harjoittamaa mieliwaltaa wastaan. Suomen pankin haarakonttori awattiin päiwällä. Iltapäiwällä saapui tieto että Helsingissä oli lakko 
          päättynyt. Täällä jatkui lakko kuitenkin iltaan asti. Illalla klo 7 oli lakkolaisilla kokous, jossa lakko päätettiin lopettaa.</p>
        <p>Töihin palattiin tänä aamuna. Samaten aloitti puhelinlaitos aamulla toimintansa.</p>
        <p>Useaan muuhun paikkakuntaan werraten kului lakko Hämeenlinnassa rauhallisesti. Wenäläinen sotawäki, se tunnustuksella mainittakoon, pysyi yleensä tapausten ulkopuolella, waikka sen 
          puoleen lienee apua anoen käännytty.</p>
      </Article>


      <div className="interTitle">22.11.1917</div>
      <Article titleText="Rangaistuksettako?">
        <p>Inho ja suuttumus täyttää mielen lukiessa niistä siltasaarelaisten murhakaartien hirmutöistä, joista sanomalehtien palstat nykyisin owat tulwillaan. „Työmiehen” katala kylwö on kantanut 
          sadon. Sen kiihoittawista kirjoituksista owat rikolliset ainekset ammentaneet toimintaohjeensa ja sosialistien johtoherrat antoiwat wenäläisen kiwäärin murhamiehen käteen. Rikoksiin on 
          heillä siten inhoittawa osuutensa ja oikeutettu edeswastuu kohdatkoon myöskin heitä.</p>
        <p>Tämän näyttäwät mainitut piirit jo tajunneenkin. „Työmies”, sanomalehdistömme häpeätahra, waikenee raukkamaisesti „kaartilaistensa” murhatöistä. Lehdellä on warmaan pätewät syynsä, sillä 
          puolueessa on suuri joukko wakawia ja järkewiäkin aineksia, jotka totuuden kuultuaan eiwät tahdo olla tekemisissä roswojen ja murhamiesten „towerien” kanssa.</p>
        <p>Sama ilmiö näkyy myöskin sosialistien nykyisessä senaattipuuhassa. Tässä kiinnittää nykyhetkellä erityistä huomiota muuan kohta. „Suurlakkotiedonantojen” mukaan waatiwat Tokoin 
          ehdokaslistalla olewat henkilöt, ennenkuin senaattiin woiwat lähteä, että eduskunnalta on saatawa sitoumus amnestian julkaisemisesta. Sosialistiset johtoherrat waatiwat siis, ei wähempää 
          kuin että kaikki ne raa'at murhat ja pöyristyttäwät wäkiwallantyöt, joihin heidän järjestämänsä ja asestamansa roswokaartit wiime päiwinä owat tehneet itsensä syypäiksi jäisiwät 
          rangaistuksetta, ja että Suomen kansaneduskunnan tulisi antaa täydellinen anteeksianto kaikelle sille, mitä sosialistien toimesta ja heidän toimihenkilöidensä alotteesta wiime päiwinä on 
          tapahtunut. Toden totta on hinta, jolla nämä herrat jälleen tahtowat „remmiin astua”, liian suuri. Ja meidän puolestamme ei ole wähintäkään wäliä, haluawatko nämä herrat muodostaa 
          senaatin wai ei. Parempi, että he pysywät poissa.</p>
        <p>Me emme tarkoita, että kaikki wiime päiwinä tapahtuneet laista hairahtumiset saisiwat ankaran rangaistuksen. Harhaanjohdetut laumat, lewottoman ajan kiihkoisessa huumassa saattawat 
          helposti eksyä tekoihin, joita he asiaa harkittuaan eiwät tekisi ja joita he jälkeenpäin katuwat. Näille kyllä woidaan myöntää anteeksianto ja unhoitus. Mutta jos edelläkerrotut 
          kaameat murhatyöt jääwät rangaistuksetta, silloin kiwetkin huutawat kostoa.</p>
        <p>Olemme wakuutetut, että myöskin sosialistien laajat piirit tuomitsewat ankarasti puoluelaistensa wäkiwallantyöt. Toistaiseksi he waikenewat, mutta waadittawa on, että paheksuminen 
          esitetään julkisesti. Ellei näin tapahdu, on puolue siinä määrin itsensä tahrannut, että kunniallisen kansalaisen siihen enään on mahdoton kuulua.</p>
        <p>„Oikeutta ja leipää”, waaditaan sosialistien julistuksessa, Tapahtukoon siis jokaiselle oikeuden mukaan.</p>
      </Article>
      <Article titleText="Sosialistien surkeutta.">
        <p>Suomen sosialistien johtajat owat tulleet maailman kuuluisiksi niistä petomaisista murhista, roswouksista ja julmuuksista, joita he murhakaartiensa awulla paniwat toimeen. Ei taideta 
          maailmassa missään kolkassa wuosikymmeniin suomen sosialisteja inhoamatta mainita, kun täältä lewiää tieto siitä, että he kansansa sortajilta owat lainanneet ne aseet, joilla murhansa 
          suorittiwat, ja että he näiden sortajien awustuksella tihutyönsä tekiwät.</p>
        <p>Mutta kehtaawatko Suomen monet sadat ja tuhannet kansalaiset, jotka kunnollisista tahtowat käydä, wielä tuollaiseen joukkoon kuulua ja tällä tawalla kunnostautuneitten johtajien 
          jäljissä kulkea. Suomen sosialisteilla on ratkaistawana, tahtowatko roistoja kannattaa wai haluawatko wielä pyrkiä saamaan kunnon kansalaisen nimen. Wastausta heiltä tähän odottawat 
          eiwät ainoastaan Suomen porwarilliset waan kaikkien siwistyneitten maiden kaikki kansalaiset, sosialistitkin mukaanluettuina.</p>
        <p>Lakon aikana osoittiwat sosialistit erittäin wihaawansa kouluja, kaikenlaisia kouluja. Niitä he innolla ahdistiwat ja waatiwat sulettawiksi. Heidän tätä innostustansa on waikea 
          käsittää. Koulut, erittäinkin koulujen oppilaat, eiwät warmaankaan ole mitään sosialisteille wastaista työtä tehneet. Eiwäthän 8 à 16 wuotiset pojat ja tytöt ole ottaneet wielä mitään 
          osaa waltiollisiin toimiin.</p>
        <p>Ei ole myöskään järjestyksen pitämiselle eduksi se, että koulujen oppilaat kaupungeissa kulkewat työttöminä pitkin katuja. — Sosialistithan sanoiwat erittäin pitäwänsä huolta 
          järjestyksestä. — Ei ole sosialismin tulewaisuudelle myöskään eduksi se että nousewaan koulunuorisoon istutetaan käsitystä, että sosialistit ase kädessä owat walmiit häiritsemään koulujen 
          työtä, wiattominta työtä mitä maailmassa on.</p>
        <p>On waikeata käsittää heidän menettelyänsä muuksi kuin wallan näytteeksi. Onhan siinä waltaa, kun muutama mies aseet kädessä kykenee ajamaan pois koulusta useampia kymmeniä ehkä 
          satojakin 8 tai 10 wuotisia tyttöjä ja poikia! Minkä urotyön tekiwätkään ne Helsingin sankarit, jotka saiwat walmistawan koulunkin lopettamaan työnsä! Heille pitäisi sosialistien antaa 
          joku risti rintaan!</p>
        <p>Se wasta oli woimannäytettä se! Surullista kyllä, ei porwari huomaa siinä urhoollisuutta, waan suurta röyhkeyttä ja opinhalweksimista. Kerrotaan että wallankumouksessa jossakin oli 
          kannettu lippua, johon oli kirjoitettu: Alas lukutaitoiset! Se warmaan on satua, mutta meidän sosialisteista ei ole satua se, kun sanotaan että he wainoamalla kouluja owat osoittaneet 
          wastustawansa ja wihaawansa kaikkea siwistystä. Työllään owat he koko maailmalle huutaneet: Alas kaikki siwistys ja lukutaito! Eikö tämäkään wielä meidän kansalle saa selwäksi, mihin 
          nykyiset sosialistit heitä johtawat?</p>
      ...
      <Article titleText="Poliisilaitoksen waltaus.">
        <p>Täkäläinen Poliisilaitos joutui heti lakon alkaessa lakkokomitean mieliwallan alaiseksi, jolloin komitea, yhdessä läänin Herra Kuwernöörin kanssa, koetti järjestellä laitosta oman 
          mielensä mukaan wähintäkään wälittämättä kaupungin yleisestä mielipiteestä. Laitoksen w. t. poliisimestari sai heti wäistyä paikaltaan ja samaten yritettiin häntä poistaa myöskin 
          sihteerinwirastaan ja oli Kuwernöörillä tällöin ehdokkaana konttoriapulainen P. Jokinen, joka olisi saanut wirkamääräyksen sihteerin paikkaan, mutta sen ohella olisi hoitanut 
          Poliisimestarin tehtäwiä, mutta huomasi Kuwernööri kait itsekin herra Jokisen sopimattomuuden koska hänen wirka-aikansa supistui yhteen päiwään, jolloin hän kirjoitteli „spriireseptejä”, 
          joita apteekkarit eiwät kuitenkaan hywäksyneet.</p>
        <p>Kuwernööri tyrkytteli sitten wirkaa eri henkilöille, kenenkään suostumatta sitä wastaanottamaan, kunnes Hattulan piirin nimismies S. Kanerwio katsoi sen itselleen sopiwan. Syytä 
          tällaiseen menettelyyn Kuwernöörin taholta ei tiedetä.</p>
      </Article>
      <Article titleText="Raakalaisten väkivallantyöt Turussa.">
        <h5>Satoja ihmisiä wangittu. — Tuomiokirkon häwäistys.</h5>
        <p>„Suurlakko” Turussa päättyi tiistaina illalla klo 9. Ne toistaiseksi wielä waillinaiset tiedot, jotka heti lakon päätyttyä saatiin, osoittiwat, että raakuus, wäkiwalta ja wehkeily 
          sotilaiden kanssa jotka ilmiöt kaikkialla owat olleet huomattawissa lakkopäiwinä, owat Turussa saawuttaneet huippunsa. Kaikkialla on liikkeellä punakaartilaisia ja sotilaita, jotka 
          kiwäärein ja kuularuiskuin pakottiwat rauhalliset asukkaat alistumaan kaikkein törkeimpiinkin mielijohteisiinsa.</p>
        <p>Lakon alkaessa keskiwiikkona oli wallankaappaajien ensimäisenä tehtäwänä wirastojen ja tärkeiden keskuksien waltaaminen. Klo 10 mennessä oliwat he ottaneet haltuunsa howioikeuden, 
          lääninhallituksen, raastuwanoikeuden ja poliisikamarin sekä puhelin- ja liikekeskukset.</p>
        <p>Tämän jälkeen alkoi häikäilemätön wangitseminen ja kotitarkastusten toimeenpano. Kuwernööri Collanin asuntoon mentäessä ei kuwernööriä tawattu kotosalla, jonka wuoksi wangitsijat 
          saiwat palata takaisin tyhjin toimin. Tunnin kuluttua riensi kuitenkin joku kawaltaja ilmoittamaan, että kuwernööri oli saapunut, ja näin joutui kuwernööri Collan wangituksi. — Saman 
          kohtalon alaiseksi joutui poliisimestari, jonka eläimelliset huligaanit waatiwat alastomana sulettawaksi putkaan — toimenpide, josta oli luowuttawa miliisimiehistön ehdottoman jyrkän 
          wastakannan wuoksi. Kummatkin wangituista owat wielä tätä kirjoitettaessa wäkiwallantekijäin huostassa ja säilytetään heitä raastuwanoikeuden toisen osaston arkistohuoneessa.</p>
        <p>Wangittujen joukosta mainittakoon edelleen wapaaherra Wrede ja hänen poikansa, von Rettig, Jansen-Storbacka, toimittaja Eino Suowa, insinööri B. Grönblom, hammaslääkäri Jörgensen, 
          komisario Aalto, jonka roskawäki pieksi puolikuolleeksi, johtaja Wikman, yliopp. Björk, pankinjohtaja Westerlund, kauppias Lundelin, tohtori I. Helo, nimismies Paawo Jäykkä, 
          eläinlääkäri K. Nyberg, lakit. kand, Nikkilä ja sangen monia muita. Yhteensä on wangittuja satoja.</p>
        <p>Kotitarkastuksien aikana, joita suomalaiset ja wenäläiset bolshewikit toimittiwat yhteiswoimin, katosi paljon arwoesineitä monista eri paikoista. Pahimmin käwi konsuli Nordfors'ille, 
          joka kotitarkastustilaisuudessa kärsi noin 200,000 markan wahingon. Myöskin arkkipiispa Johanssonin luona toimitettiin kotitarkastus, eikä edes tuomiokirkko säilynyt tältä riwolta 
          häikäilemättömyydeltä. Siellä toimitetussa „kotitarkastuksessa” pengottiin erityisellä innolla Tottien holwia.</p>
        <p>Kuten jo aikaisemmin olemme maininneet sai kotitarkastusten yhteydessä surmansa kauppias Dammert J:or.</p>
        <p>Elintarpeisiin nähden elettiin kaupungissa lakon aikana hurskaasti — kerrankin, syöden elintarwelautakunnan kaikki talwisäästöt. Tuloksena oli se, että lakon maanantai-iltana loppuessa 
          oliwat elintarpeetkin loppuneet aiwan wiimeisiin asti.</p>
      </Article>
      <Article titleText="Punaiset roswot palowerottaneet kaupunkia 1/2 milj. markalla.">
        <p>Tiistaina kruunasiwat punaiset roswojoukot konnamaiset wäkiwallantyönsä palowerottamalla Turun kaupungia. Waatimuksena oli alkujaan 5 milj. markkaa, mutta tingittiin tämä määrä 
          lopulta ½ miljoonaksi. Rahatoimikamarin jäsenet uhattiin murhata, ellei rahoja heti suoriteta, sekä ryöstää pankit j. n. e. Näin ollen kamari katsoi olewansa pakoitettu omansa ja 
          kaupungin turwallisuuden tähden maksamaan rahat. Waltakirja, jolla rahat nostettiin, oli näin kuuluwa:</p>
        <p className="quote">Asettamamme raha-asiain waliokunnan waltuutamme täten nostamaan Smk. 500,000:— (wiisisataatuhatta) kaupungin waroja ja on waliokunnalla oikeus käyttää wäkiwaltaa, 
          jos heille ei sanottuja rahawaroja luowuteta.<br />Yllämainittuun waliokuntaan kuuluwat: Akseli Kanerwa, R. W. Österman, Arwo Airisto, Jussi Sandholm ja A. 
          Kallio.<br /><br />Kunnallisjärjestö ja johtawa Komitea.<br /><br />Ernst Lähde, puheenjohtaja,<br />Arwo Airisto, sihteeri.</p>
        <p>Edelläkerrotulla tawalla saatu saalis jaettiin heti punakaartilaisten kesken siten, että he saiwat koko lakkoajalta 30 mk. päiwältä miestä kohden sekä naineet 50 mk.</p>
      </Article>
      <Article titleText="Hirmuvalta Helsingin ympäristössä.">
        <h4>Murhia ja wäkiwallantöitä.</h4>
        <h5>Werityöt Malmilla.</h5>
        <p>Torstai-aamuna pääsiwät eläimelliset intohimot walloilleen Malmin seuduilla. Tällöin surmattiin mitä kauheimmalla tawalla poliisikonstaapeli A. Packalén, jonka luona sattui parhaillaan 
          olemaan poliisikonstaapeli Örthén. Mikäli olemme saaneet tietää, olisi tapauksen kulku ollut seuraawa: Torstai-aamuna klo puoli 8 tienoissa oli saapunut joukko kiwääreillä warustettuja 
          punakaartilaisia Packalénin kotiin, pukeneet hänen yllensä poliisin waatteet, raastaneet hänet ulos sekä iskeneet häntä kiwäärinperillä ja pistimillä niin, että sisälmykset waluiwat 
          ulos. Kaikki tämä tapahtui Orthenin ja mikäli kerrotaan onnettoman waimon ja lasten nähden. Tämän jälkeen oli uhriin ammuttu useita laukauksia ja hengetön ruumis heitetty ratawallin 
          ojaan.</p>
        <p>Tämän tapahduttua ampui Orthéniä eräs sotilas suoraan rintaan. Hän kuljetettiin kulkutautisairaalaan, josta tuotiin autolla kirurgiseen sairaalaan Helsinkiin.</p>
        <p>Torstai-aamuna yritettiin murhata Malmilla nimismies F. Haupt samaan aikaan kuin edellämainittu Packalénkin. Nimismies Haupt oli klo puoli 8 tienoissa aamulla warhain käynyt 
          puolipukeissa ulkona kellarissaan. Täältä palatessaan ja asuntonsa rappusille ehdittyään ampuiwat häntä wastaan pihan ympäristölle waanimaan asettuneet roistot yhteislaukauksen. Yksikään 
          luodeista ei kuitenkaan osunut ja kerrotaan nimismiehen asuntoonsa pyrkiessään huudahtaneen: „Olettepa rohkeita miehiä, kun ammutte aseetonta!” Sisälle hän ei kuitenkaan päässyt, sillä 
          hänen taloudenhoitajattarensa oli kauhuissaan sulkenut owen. Tällöin kajahti uusi yhteislaukaus, josta kaksi luotia osui murskaten pahoin nimismies H:n säären. Tämän jälkeen hyökkäsiwät 
          huligaanit esiin lyöden ja raastaen wielä uhriaan. Toiset heistä tunkeutuiwat särjettyjen ikkunoiden kautta asuntoon, josta warastiwat hra Hauptin kultakellon sekä hänen laukkunsa, joka 
          lienee sisältänyt asiakirjoja. Kerrotaan myös, että hänen taloudenhoitajattarensa olisi tässä tilaisuudessa liewästi haawoittunut olkapäähän.</p>
        <p>Nimismies Haupt tuotiin yhdessä konstaapeli Orthénin kanssa kirurgiseen sairaalaan. Tiedustellessamme eilen sairaalasta haawoitettujen tilaa, ilmoitettiin heidän olosuhteihin nähden 
          woiwan werrattain hywin.</p>
        <p>Perjantaiaamuna murhattiin ampumalla niinikään Malmilla kansakoulunopettaja A. Bjon. Tapahtumasta kerrotaan, että sanottuna aamuna klo 11 tienoissa tunkeutui hra Bjonin asuntoon 
          aseellinen miesjoukko, joka wangitsi hänet lähtien häntä kuljettamaan pois kotoaan. Pihalle ehdittyä olisi wangittu yrittänyt paeta. Tällöin ampui eräs weritöiden tekijöistä häntä 
          takaapäin, jolloi hra Bjon tupertui suulleen maahan. Tämän jälkeen oli häneen wielä ammuttu 5 laukausta. Toisen kertomuksen mukaan tapasiwat murhaajat ensin rwa Bjonin, jonka waatiwat 
          opastaaman heitä kotitarkastuksen toimeenpanossa. Tällöin oli löytynyt wanha käyttökelwoton rewolweri. Tämän jälkeen lähtiwät huligaanit kuljettamaan hra Bjonia punakaartiin pääwahtiin, 
          mutta kun pidätetty esteli, oli hänet pantu seisomaan pihalla seinää wasten ja ammuttu häneen 7 laukausta, jolloin uhri oli hengetönnä waipunut maahan.</p>
        <p>Hra Bjon oli yli 50 wuotias.</p>
        <h5>Hirwittäwä punakaartilaisten tekemä kaksoismurha Fredriksbergissä.</h5>
        <p>Sunnuntaiaamuna klo 7 seuduissa saapui noin 30 miestä käsittäwä aseistettu punakaartilaisten joukko leskirouwa Sahlströmin lähellä Fredriksbergin asemaa asuman rakennuksen pihamaalle, 
          ampuen ensin talon koiran kuoliaaksi ja haawoittaen tallissa olewaa hewosta jalkaan. Senjälkeen joukko ryntäsi asuinrakennuksen portaille, jyskyttäen owea ja waatien asukkaita tulemaan 
          ulos. Suoraan wuoteestaan nousiwat silloin perheen wanhimmat weljet Gunnar ja Ragnar Sahlström, mennen tulijoita wastaan yöpukimissaan. Gunnar Sahlströmin awattua owen raastettiin hän 
          hurjien miesten joukkoon. Kysymykseen, missä talon aseet owat, hän wastasi, ettei sellaisia heillä ollut, mutta samassa joukko ampui häneen useita laukauksia, joiden uhrina hän paikalle 
          kaatui. Nähdessään wanhemman weljensä kohtalon yritti nuorempi Ragnar etsiä suojaa läheisten puiden takaa, mutta hänkin ammuttiin muutamien metrien päässä rakennuksesta. Myöskin 
          kolmatta, 15-wuotiasta weljeä uhattiin aseilla, jolloin hätääntynyt äiti asettui hänen suojakseen saaden laukauksen itse kohtaansa sen kuitenkaan sattumatta. Werityönsä tehtyään joukko 
          ryntäsi huoneustoon, uhaten edelleen rouwa Sahlströmiä ja hänen kahta eloon jäänyttä poikaansa, joista nuorin wielä lepäsi wuoteessaan, sekä kiwääreillä että rewolwereilla, myllersiwät 
          huonekalut ja kaikki paikat nurin, mitään aseita löytämättä. Hurjistuneet miehet esiintyiwät täysin petomaisesti silpoen murhatun Gunnar Sahlströmin ruumiin kauhistuttawalla tawalla 
          luodeilla ja pistimillä. Murhaajien joukossa olleista miehistä tunnetaan jotkut.</p>
        <p>Murhatuista weljistä oli Gunnar Sahlström 22-wuotias ja antautunut kodin maatalouden hoitoon. Nuorempi Ragnar Sahlström oli 19-wuotias, Suomalaisen Normaalilyseon VII luokan oppilas, 
          hiljaiseksi ja uurastawaksi oppilaaksi tunnettu, joka loma-aikoina läpi wuosien oli tehnyt ruumiillista työtä tehdäksensä koulunkäyntinsä mahdolliseksi. Hänellä oli soitannollisia 
          harrastuksia, joille hän wälihetkinään mielellään antautui. Hän oli aikaisemmin syksyllä kuulunut paikkakunnan suojeluskuntaan, mutta eronnut siitä koulutyön aljettua. Ainoastaan tämä 
          seikka näyttää murhamiehille olleen riittäwänä aiheena kauhistuttawan tihutyön tekemiseen.</p>
        <h5>Murhia Tikkurilassa.</h5>
        <p>Wiime lauantaina toimeenpani Tikkurilan murhakaarti paikkakunnan koko wäestöä sywälti järkyttäneen werityön. Klo 2—3 tienoissa päiwällä tuli maantiellä tilanhoitaja Gösta Brondinia ja 
          liikemies Karl Magnus Montellia wastaan 20-30-miehinen kiwääreillä aseistettu miesjoukko lähellä Tikkurilan asemaa. Jo kaukaa huusiwat he sanotuille henkilöille: kädet ylös! 
          Lähestyttyään toimeenpaniwat huligaanit taskujen tarkastuksen, etsien pidätetyiltä aseita, joita ei kuitenkaan löytynyt. Samassa kuului laukaus ja luoti sattui hra Brondinia oikealle 
          puolen rintaan. Haawoittunut wietiin Ånäsin koelaitokseen, jossa sattumalta oli paikalla sairaanhoitajatar, joka antoi hra A:lle ensi awun. Sittemmin sai hän — lakkoepäjärjestyksen 
          wuoksi — odottaa aina klo 8:aan asti ip. ennenkuin pääsi tawarajunassa Tikkurilasta Helsinkiin ja autossa asemalta kirurgiin. Kauheita tuskia kärsittyään heitti hra Brondin täällä 
          sunnuntai-iltana henkensä. Hän toimi Tikkurilassa sijaitsewan Mösskärr-nimisen tilan hoitajana ja oli kuollessaan 37 wuoden ikäinen.</p>
        <p>Kerrotussa rytäkässä pääsi hra Montell pakoon, ollen pakoitettu sen jälkeen piiloittelemaan metsissä, uskaltamatta lähestyä kotiaan. Tiedettiin punakaartilaisten häntä yhä waanineen 
          ja pelättiin pahinta, kunnes eilen aamulla aawistukset osottautuiwat tosiksi kammottawalla tawalla. Tällöin nimittäin löydettiin hänen ruumiinsa hengetönnä metsästä. Pään läpi oli 
          ammuttu kaksi luotia ja rinta oli läwistetty pistimellä.</p>
        <h5>Albergassa ammuttu nimismies ja kaksi poliisia.</h5>
        <p>Sunnuntai-illalla saiwat surmansa Albergan punakaartilaisten pidättämät Espoon nimismies H. Berglund, poliisi Engman ja eräs toinen poliisi. Lähempiä tietoja tapahtumasta puuttuu.</p>
        <h5>Uhrien lukumäärä kaswaa yhä.</h5>
        <p>Sunnuntaina lähti Helsingistä howioik. ausk. Andreas von Bell hewosellaan kyyditsemään Tuusulaan howioik. ausk. Falekia, joka oli määrätty istumaan Tuusulan käräjät. Paluumatkalla oli 
          von Belliä ammuttu Malmilla niin pahoin, että kuolema seurasi.</p>
        <h5>Kotitarkastuksia Wantaan ja Kårbölen seuduilla.</h5>
        <p>Perjantaina toimeenpani 60 miehinen aseistettu punakaartilaisten joukko kotitarkastuksen agr. Leo Järnströmin omistamassa Malmin kartanon wirkatalossa Kårbölessä. Saaliina wietiin n. 
          6,000 mkn arwosta hopeaesineitä. Kellareissa tyhjennettiin ja rikottiin mehupulloja sekä tehtiin muita ilkiwaltaisuuksia.</p>
        <p>Wantaalla sijaitsewasta Dahlströmin wiilatehtaasta warastettiin wiiloja n. 2,000 mkn arwosta. Aseita etsittiin Gårdsin, Hommaksen y. m. kartanoista.</p>
        <h5>Kahakka Saksanniemessä.</h5>
        <p>Lauantaina klo 12 päiwällä saapui Kiialan pysäkille Helsingistä junalla n. 800 miestä käsittäwä punakaartilaisosasto mukanaan sairashoitohenkilökunta. Kiialasta alkoiwat 
          punakaartilaiset ampumaketjussa lähestyä Saksanniemen kartanoa piirittäen sen melkein kokonaan. Saksanniemeen sijoitettu n. 200 miestä käsittäwä, harjoitettawa poliisimiehistö oli 
          uhkaawan yliwoiman wuoksi walmistautunut poistumaan Saksanniemestä. Hewoset oliwat walmiiksi satuloituna ulkohuonerakennuksen takana. Punakaartilaiset otettiin wastaan yhteislaukauksella 
          — poliisimiehistöllä oli kuitenkin wain 12 kiwääriä, berdan mallia, ja n. 30 rewolweria, punakaartilaiset oliwat asestettuina wenäläisiltä saaduilla makasiinikiwääreillä. Laukauksen 
          ammuttuaan nousi miehistö satulaan ja ajoi paikalta kolmessa osastossa. Kahakassa kerrotaan 6 —10 punakaartilaisen haawoittuneen, jota paitsi rakennuksesta on tawattu kahden poliisien 
          keittiöhenkilökuntaan kuuluwan Kuuston ja Fallströmin ruumiit. Toinen miehistä oli pistetty ja toinen ammuttu kuoliaaksi.</p>
      </Article>
      <Article titleText="Lakon jälkimaininkeja.">
        <h5>Punakaartilaiset wallanneet junan.</h5>
        <p>Eilen päiwällä waltasi Loimaan asemalla 6 rewolwereilla aseistettua punakaartilaista Toijalasta Turkuun matkalla olewan matkustajajunan weturin. Kuolemaa uhaten he pakoittiwat 
          kuljettajan irroittamaan weturin junasta ja lähtemään wiemään heitä Turkua kohden. Junan matkustajawaunut jäiwät asemalle.</p>
        <h5>Tehtaat seisowat.</h5>
        <p>Warkauden, Lehtoniemen ja Mäntän tehtaat owat päättäneet pitää tehtaat suljettuina siksi kunnes punakaartilaisten ryöwäämät tehtaiden wirkailijain aseet ja muut tawarat owat palautetut. 
          Tämän johdosta owat Mäntän tehtaan työläiset wanginneet tehtaan johtajan G. Serlachiuksen.</p>
        <h5>Kotkassa lakko jatkuu.</h5>
        <p>Kotkassa jatkuu lakko todennäköisesti edelleen, sillä puhelinyhteys on katkaistu, eikä mitään tietoja ole saapunut.</p>
        <h5>Helsingissä pidätettyjä wapautettu.</h5>
        <p>Helsingissä pidätettyjen kuulusteluja on eilispäiwän kuluessa toimittanut jonkinlainen työwäen tutkimuslautakunta. Päiwän kuluessa wapautettiin useita kymmeniä henkilöitä.</p>
        <p>Eilen päiwällä oli Helsingin poliisikamarissa wielä punakaartilaisjoukkoja.</p>
        <h5>Kuwernööri Jalander.</h5>
        <p>Kuwernööri Jalander on eilen siirretty Helsingin lääninwankilaan.</p>
        <h5>Wirastot.</h5>
        <p>Eilen ei Uudenmaanläänin lääninhallitus toiminut lainkaan. Senaatti ja lukuisat keskuswirastot owat toimineet wain ositttain.</p>
        <h5>Malmilla punakaartilaiset edelleen mellastamassa.</h5>
        <p>Malmilla owat punakaartilaiset wielä toimittaneet kotitarkastuksia. Puhelinjohdot owat rikotut useihin taloihin.</p>
      </Article>

      <div className="interTitle">24.11.1917</div>
      <Article titleText="Uusia kauhuntietoja maaseudulta.">
        <p>Perjantain wastaisena yönä alkoi 26 henkeä käsittäwä Kangaslammin työwäenyhdistyksen jäsenten muodostama roswojoukko mellakoida Kangaslammilla, johtajinaan tyhjäntoimittaja O. Tiihonen 
          ja seppä O. Kuwaja käyden muka aseita waatimassa ja häiriten rauhallisia asukkaita yhdeksässä talossa. Senjälkeen terrorisoiwat he koko pitäjän ja työwäentalo oli roswojen päämajana. He 
          ilmoittiwat riistäwänsä aseet porwareilta alottaakseen sitten järjestelmällisen ryöstön ja talojen tasajaon. Wastustajansa lupasiwat he tappaa, mainiten m. m. howioik. asessori E. W. 
          Sopasen ja maanwilj. A. Erosen ensimäisinä aikominaan uhreina. Kun tilanne näin oli kärjistynyt äärimmilleen, pidettiin wiime sunnuntaina yleinen kansalaiskokous, jossa tultiin siihen 
          tulokseen, että huligaanit lupasiwat luowuttaa aseensa lainajywästön makasiinissa säilytettäwiksi lakon loppuun. Mutta pian muuttiwat he mieltään ja kun kokouksen lähetystö saapui aseita 
          noutamaan, ilmoittiwat huligaanit, etteiwät he niitä luowuta. Rantasalmen nimismiehen Partasen aikoiwat he samalla wangita, mutta kun nimismies ei suostunut rupeamaan wangittawaksi, waan 
          lähti pois, niin ampuiwat he häntä selkään. Nimismies waipui werissään tielle. Majataloon, missä oliwat howioik. asessori Sopanen ja 11 muuta henkilöä, saapuiwat huligaanit piirittäen 
          sitä maanantaiaamuun saakka. Maanantaina kutsui kruununwouti Manninen Sawonlinnasta joukon sikäläisiä suojeluskuntalaisia, jotka saapuiwat Kangaslammille pidättäen ja kuulustellen useita 
          henkilöitä. Useimmat huligaanit oliwat kuitenkin jo luikkineet tiehensä. Tiistaiaamuna klo 8 aikaan ampuiwat huligaanit suojeluskuntalaista, Itä-Sawon toimittajaa K. Tiihosta, joka 
          saamastaan haawasta kuoli samana aamuna klo 11 aikaan. Nimismies Partasen haawat eiwät ole hengenwaaralliset.</p>
        <p>Loimaalta mainitsimme jo, että huligaanit anastiwat sieltä erään junan weturin matkustaen Turkuun. Sinne saawuttuaan hakiwat huligaanit apujoukkoja Loimaalle Turun punakaartista, 
          josta saiwatkin n. 300 miestä mukaansa. Kuolemalla uhaten waatiwat he Turun asemapäälliköltä junaa joukolleen matkustusta warten Loimaalle. Miten kuten pääsi asemapäällikkö kuitenkin 
          pälkähästä junaa antamatta. Tällöin waltasiwat he ampumalla Helsinkiin lähdössä olewan matkustajajunan, johon nyt sijoitettiin 1300 punakaartilaista, 40 merisotilasta ja 2 kuuluruiskua. 
          Sen jälkeen alkoi retki Loimaalle jossa junaa ilmoitettiin odottawan Loimaan suojeluskunnan.</p>
        <p>Keskiwiikkona klo 11 ajoissa aamupäiwällä sattui siellä yhteentörmäys ja taistelu 50 suojeluskuntalaisen ja 200 punakaartilaisen wälillä. Siinä taistelussa haawoittui muutamia 
          henkilöitä. Wälttääkseen enempää werenwuodatusta, alkoi suojeluskunta hajaantua. Tällöin kulki 6 suojeluskuntalaista entisen Loimaan paperitehtaan rakennusten ohi. Sinne oli kätkeytynyt 
          wäijyksiin toistasataa punakaartilaista, jotka alkoiwat ampua suojeluskuntalaisia yhteislaukauksin. Kaksi suojeluskuntalaista, joiden nimistä ei kuitenkaan ole wielä tietoa, sai siinä 
          surmansa. Suojeluskuntalaiset ennättiwät myöskin ampua muutamia laukauksia, joista sai surmansa punakaartilainen J. Lilja. Toinen punakaartilainen on hywin heikkona sairaana 
          hoidettawana Turun lääninsairaalassa. Hän oli saanut luodin watsansa läpi.</p>
        <p>Niinkuin tunnettua lähti suurin osa surullisen kuuluisaa Kotkan roswokaarttia Wiipurista rosworetkille Karjalan ja Hiitolan—Raasulin radan warsille. Torstaina saatiin Pyhäjärwelle 
          tieto, että kaarti oli saapumassa sikäläiselle rautatieasemalle ylimääräisellä junalla, jonka edessä oli kaksi weturia ja jälessäkin wielä yksi. Asemalle kerääntyi joukko ympäristön 
          maamiehiä estääkseen roswojoukon pääsemisen ryöstöjä harjoittamaan.</p>
        <p>Mutta jotkut paikkakunnan huligaanit oliwat ehättäneet toimittamaan tulossa olewalle joukolle sanan asemalle kokoontuneista wartioista. Sentakia nämä pysäyttiwät junan jonkun matkan 
          päähän asemalta ja lähtiwät marssien asemaa walloittamaan. Päästyään aseman lähelle, alkoiwat he kiiwaan ammunnan, johon asemalla olewat wastasiwat niillä wähillä aseilla, joita heillä 
          oli käytettäwissä. Jonkun ajan kuluttua saiwat roswojoukkoa wastaan taistelewat apuwäkeä, joka tuli roswojen selän takaa. Asemalla olleet lakkasiwat silloin ampumasta peläten 
          haawottawansa apuwäkeä. Nyt syntyi käsikähmainen taistelu mies miestä wastaan roswojen kanssa, joiden wihdoin oli pakko lähteä käpälämäkeen.</p>
        <p>Sen mukaan kuin on saatu tietää, sai taistelussa surmansa 4 roswojoukon jäsentä ja 3 heidän wastustajiansa, joiden lisäksi useita on taistelussa haawottunut. Tarkempia tietoja 
          taistelusta ei ole wielä saatu.</p>
        <p>Pyhäjärweltä owat roswot siirtyneet Sakkolaan ja Rautuun, joissa kerrotaan myöskin tapahtuneen werisiä taisteluita, mutta niistä ei ole wielä ennätetty tietoja saada.</p>
        <p>Torstaina klo 1 aikaan päiwällä meniwät Kawansaaren asemalla maanwiljelijä Juho Olkinuora, sähköttäjä Arwi Nygren, kaupanhoitaja Kunnas, kauppa-apulainen Wiljo Olkinuora, 
          maanwiljelysharjoittelija Waltteri Suonio sekä asemamies Ulmanen sikäläiselle työwäentalolle noutamaan sieltä pois heiltä takawarikoituja, mutta takaisin luwattuja aseita.</p>
        <p>Kun he pääsiwät talon edustalle, awattiin äkkiarwaamatta talon ikkunoista ankara tuli heitä wastaan. Tällöin sai Nygren luodin wasempaan silmäänsä sekä useampia haulikon luoteja 
          käsiwarteensa ja kylkeensä. Hän kykeni kuitenkin juoksemaan parin kilometrin päässä olewaan kotiinsa. Maanwiljelijä Olkinuoraa ammuttiin pään läpi, että aiwot tuliwat ulos. Toiset 
          pääsiwät wahingoitta.</p>
        <p>Haawoittuneet tuotiin Wiipurin lääninsairaalaan hoidettawaksi. Maanwiljelijä Olkinnoran tila on toiwoton.</p>
      </Article>
      <div className="interTitle">29.11.1917</div>
      <Article titleText="Uusia weritöitä paljastunut Helsingin pitäjässä.">
        <h5>Helsingin pitäjän w. t. poliisikonstaapeli Hugo Aleksander Helenius murhattu.</h5>
        <p>Wiime perjantaina löydettiin Helsingin pitäjän hautausmaan läheisyydestä poliisikonstaapeli Hugo Aleksander Heleniuksen ruumis.</p>
        <p>Wainaja oli lakkopäiwien kuluessa saapunut asuntoonsa Sjöskogiin, jossa hän asuu yhdessä erään toisen poliisimiehen Edgar Winqwistin kanssa. Tällöin joutui hän waaniskelewan 
          huligaanijoukon huomion esineeksi. Joukon ryhtyessä häntä ahdistamaan pakeni hän metsään ja onnistui täten aluksi wälttämään roskajoukon wainot. Kaikki merkit wiittaawat olettamukseen 
          että wainolaisjoukko oli myöhemmin saawuttanut hänet ja ryhtynyt kuljettamaan häntä wangittuna Malmille päin. Matkalla oli hänet kuitenkin murhattu. Tämäkin murha on laskettawa Malmilta 
          pitäjää kiertämään lähteneiden n. s. punakaartilaisjoukkojen ansioksi.</p>
        <p>Wainaja joka wain wähän aikaa on palwellut poliisikonstaapelinä Helsingin pitäjässä, oli kuollessaan 29 wuoden ikäinen.</p>
        <h5>Weritöitä Pusulassa.</h5>
        <p>Perjantaina klo 3 aikaan iltapäiwällä ajoi Pusulan Kärkölänkylän työwäentalon siwutse wiewää maantietä talollisenpoika Emil Mäkinen samasta kylästä, yhdessä talollisenpojan Juho Kawilan 
          kera Pyhäjärwen U.l. Wattolasta. Kun ajajat oliwat tulleet työwäentalon kohdalle, pidättiwät heidät talon pihamaalla wahdissa olleet eläkemiehenpoika Heino Armas Wahtera ja räätälinpoika 
          Kalle Ilmari Mäkinen paikkakunnalta sekä irtolainen Leino Forssasta. Hewosta ohjannut Emil Mäkinen nousi tällöin reestä, lähtien talon pihamaalle, jolloin hänelle komennettiin: 
          „Kädet ylös”. Mutta ennenkuin hän oli ehtinyt portaille asti ammuttiin häneen kaksi hirwikuulaa; Mäkinen kuoli heti. Senjälkeen joutui wäkiwallan uhriksi Kawila, joka oli noussut pitämään 
          hewosta kiinni suitsista. Häntäkin ammuttiin kahdesti samanlaisilla kuulilla. Kawila, joka niinikään kuoli heti, jäi riippumaan suitsiin kiinni hewosen laukatessa kymmenkunta metriä 
          eteenpäin.</p>
        <p>Syytä tällaiseen werityöhön ei toistaiseksi tunneta, sillä poliisitutkintoa ei wielä ole woitu toimittaa. Aseita ei kumpaisellakaan ollut mukanaan.</p>
      </Article>
      <div className="interTitle">1.12.1917</div>
      <Article titleText="Mielenilmaisut äskeisten tapahtumien johdosta.">
        <p className="accent centered">Sosialistien taholta</p>
        <p>on U. S:lle lähetetty m.m. seuraawa, asianomaisten lähettäjien nimillä warustettu kirjoitus.</p>
        <h5>Sosialidemokraattisen puolueen loppu.</h5>
        <p>Warmaa on, että kuluneina weripäiwinä on kaiwettu hautaa sos.-dem. puolueelle ja haudankaiwajina owat olleet punakaartit. Tästedes merkitsee kansan tajunnassa sosialistinimitys samaa 
          kuin murhaaja ja ryöwäri. Minkäänlaista luottamusta eiwät tule nykyiset puolueen etumiehet enää milloinkaan nauttimaan; he owat itse teossa osoittaneet, että he eiwät kykene johtamaan 
          eiwätkä arwostelemaan, waan toimiwat kuin edeswastuuttomat huligaanit. Eduskunnassa olewat esiintywät puheissaan iwaillen ja irwistellen kuin katupojat ja huligaanimaisin liikkein. Ei 
          jälkeäkään siitä arwokkaisuudesta, joka pitäisi niillä olla, jotka owat walitut kansan edustajiksi tärkeään lainsäädäntötyöhön.</p>
        <p>Poissa on se ihanteellinen pohja sosialidemokrateilta, joka on meitä innostuttanut ja lämmittänyt aatteelliseen taisteluun wanhaa yhteiskuntajärjestelmää wastaan. Mutta nyt — nyt on 
          tehty kohtalokas wääryyden työ; wedetty kaikki weriseen suohon, josta puolue ei enää tule nousemaan milloinkaan. Me emme tule enää ottamaan osaa minkäänlaiseen puolue-elämään. Ellei synny 
          mitään uutta, aatteellista puoluetta, joka wastaisi sos.-demokratiaa, niin liitymme johonkin muuhun puolueeseen, joka on tätä lähempänä, tai sitte olemme willeinä, mutta ei missään 
          tapauksessa enään puolueessa, joka on Kainin merkeillä merkitty ja weren tahraama. Tiedämme warmaan puhuwamme tuhansien työntekijäin puolesta, jotka näihin päiwiin asti owat kuuluneet 
          sos.dem. puolueeseen.</p>
        <p>Kirjoitamme tämän Uuden Suomettaren toimitukselle, koska hywin arwaamme, että Työmies ei kuitenkaan tätä julkaisisi!</p>
        <p className="signature">Joukko etelä-Hämeen sosialidemokratisen puolueen entisiä jäseniä.</p>
      </Article>
      <Article titleText="Aseiden tuontia Suomeen.">
        <h5>Siwiilihenkilöt toimittawat Pietarista aseita ja ampumawaroja.</h5>
        <p>Eilisiltana klo 8 aikaan Pietarista lähtewässä junassa n:o 7 lähetettiin Suomeen kaksi waununlastia aseita. Niistä toinen waununlasti oli osotettu Kouwolaan, toinen Helsinkiin. 
          Lähetysasemalla tiedetään, että mainittu aselähetys olisi tapahtunut komissario Rahjan toimesta.</p>
        <p>Myöhemmin ilmoitetaan Wiipurista:</p>
        <p>Kun mainittu juna saapui Terijoelle ja tulliwiranomaiset tahtoiwat pidättää mainittuja waunuja tullitarkastusta warten ilmestyi tulliwiranomaisten puheille eräs henkilö, joka ilmoitti 
          olewansa „toweri” Rahja ja huomautti, ettei kellään ole oikeutta pidättää mainittuja waunuja. Waunujen numerot oliwat 8,934 ja 6,855.</p>
        <p>Waunuissa kerrotaan olewan 500 kiwääriä ja 50,000 patruunaa. Kiwäärit owat wiime aikoina käytännössä ollutta lyhyttä mallia. Asewaunuissa oli mukana muutamia siwiilihenkilöitä.</p>
        <p>Edellisen yhteydessä mainittakoon, että pari kolme päiwää sitten on samalla tawalla Suomeen lähetetty ampumatarpeita 80,000 patruunaa.</p>
        <p>Kenelle ja mihin tarkoitukseen aseet owat aiotut, siitä ei ole wielä lähempiä tietoja.</p>
      </Article>

      <div className="interTitle">4.12.1917</div>
      <Article titleText="Huligaanimellakka Forssassa.">
        <h5>Wälikäräjät keskeytetty. Nimismies ajettu pois oikeuspaikalta.</h5>
        <p>Tammelan wälikäräjien piti alkaa w. k. 28 pnä käräjätalolla Forssan W. P. K:n huoneustossa. Kello puoli 2 aikaan päiwällä kokoontui sanotun talon pääowen edustalle muutamia Forssan ja 
          Tammelan huligaaneja, kantaen punakaartin merkkiä, estämään käräjäwiranomaisten huoneustoon pääsyä. Etupäässä kohdistui estely waratuomari hra A. Sylwiniä kohtaan, jolloin jo lausuttiin 
          solwaisusanoja y. m. Kaikista huolimatta onnistui kuitenkin wirantoimittajain päästä sisälle ja toimitus woitiin alkaa kuulustelemalla erästä miestä, joka wankilasta oli oikeuspaikalle 
          tuotu. Hetken kuluttua saapui kuitenkin sama räyhääjäsakki kaksinkertaisena takaisin oikeuspaikalle törmäten suoraan oikeussaliin, missä mainittua juttua paraikaa käsiteltiin. Suurta 
          ääntä ja rähinää pitäen häiritsi joukko oikeuden istuntoa ja kun tuomari asessori Furuhjelm tiedusteli syytä moiseen tekoon, huusiwat huligaanit, että he owat tulleet wiemään nimismies 
          Sylwin'in pois syyttäjän paikalta, jolla hänellä ei muka ole „kansan” erottamana oikeutta olla. Kun tuomari huomautti että hänellä olisi oikeus käskeä pois oikeuspaikalta 
          rauhanhäiritsijät, niin ääni wain yltyi, jonka jälkeen tuomari pyysi sakkia poistumaan. Tästä oli seurauksena, että sakin johtajat käwiwät käsiksi herra Sylwin'iin laahatakseen hänet 
          ulos. Herra Sylwin huomautti, että hän tahtoo pukea päällyswaatteet päälleen, johon estelyjen jälkeen sakki wiimein raa'asti huusi „Pa sitte, mutta pa pian”. Owissa tyrkkiwät 
          raakalaiset herra S:iää, ja kun ulos päästiin, asettui yksi osa hra S:in edelle ja toiset perään ja näin saatettiin herra Sylwin asunnolleen asti. Sen jälkeen palasi sakki wapauttamaan 
          wankeja ja olkoon kuwaawana piirteenä mainittu, että paikalle kerääntyneestä uteliaiden joukosta kuului naisen ääni, joka sanoi: „jos nyt olis hywin paljon wankeja, niin kaikki 
          laskettaisiin irti”.</p>
        <p>Samoin olkoon mainittu, että alussa mainittu mieswanki suoraan pyysi tuomarilta, että ainakin hänen asiansa läpikäytäisiin ja pahoitteli huligaanien menettelyä, mutta asian saatua näin 
          ikäwän keskeytyksen ei tuomari woinut sille mitään.</p>
        <p>Asian yhteydessä owat silminnäkijät kertoneet, että mainittu sakki warusti itsensä aseilla wieressä olewasta työwäentalosta, ollen muutamilla niin kiire että aseita asetettiin piiloon 
          wasta oikeustalon owen edessä. Erikoisiksi wahdeiksi oli talon nurkalle asetettu muutamia kiwääreillä warustettuja miehiä.</p>
        <p>Huligaanit pidättiwät oikeuspaikalla myöskin poliisikonstaapelit I. Idän ja I. Männistön kulettaen heidät Forssan poliisikamarin kylmään putkaan, missä miehet saiwat wirua 5 tuntia.</p>
        <p>Warmennukseksi siitä, että tällainen teko sai alkunsa edellisenä iltana työwäen talolla pidetyssä järjestyneen työwäen kokouksessa, woidaan mainita, että kun tuomari kysyi, kenenkä 
          käskystä he owat tulleet meteliä pitämään oikeuspaikalle, wastasiwat sakilaiset „järjestyneen työwäen käskystä”. Sieltä olikin erään suutarin ehdotuksesta päätetty estää hra Sylwin 
          wirkaansa toimittamasta wälikäräjissä, huolimatta siitä, että läänin kuwernööri samana päiwänä käydessään Forssassa oli huomauttanut teon laittomuudesta, kun ei ainakaan hän woi 
          wirkamiehiä ilman laillista syytä erottaa wiroistaan.</p>
        <p>Kauan onkin Forssan huligaanisakki, etupäässä sellaiset henkilöt, jotka owat rikoksista olleet syytettyinä, hautoneet kostotuumaa Forssan järjestyslaitosta wastaan ja kun nyt lakon 
          aikana Forssan järjestyneen työwäen awulla ja aseilla, joita työwäki on hankkinut, pakoitettiin järjestyslaitos toimettomuuteen asettamalla Antton Aaltonen miliiseineen järjestystä 
          pitämään, niin saatiin aikaan tilanne jonka aikana kaikkein huonoimmat ainekset owat saaneet mellastaa mielin määrin, mikä wiimein on wienyt siihen mitä on kerrottu.</p>
        <p>Omituisena seikkana mainittakoon, että miliisille oli koko sanotuksi päiwäksi annettu lomaa ja miliisipäällikkö oli mennyt metsästysretkelle.</p>
      </Article>
      <div className="interTitle">6.12.1917</div>
      <Article titleText="Anarkia lisää nälänhätää Suomessa.">
        <h5>Punakaartilaiswallankumous tekee wiljantuontitoiweet Amerikasta tyhjäksi.</h5>
        <p>Senaattiin on tullut wirallisesti sähkösanomalla tieto, että Amerikan hallitus oli jo wapaaksi päästänyt kaksi Suomeen ostettua laiwalastia wiljaa, yhteensä 10 milj. kiloa. Mutta kun 
          saapui tietoja weriwiikon anarkiasta, peruutti Yhdyswaltojen hallitus wientilupansa.</p>
        <p>Nälkäisten pahimmat wiholliset ovat huligaanijärjestöt ja niitä tukewa sosialistipuolue.</p>
      </Article>
      <Article titleText="Sosialistien kunnallispolitiikkaa.">
        <h5>Helsingin kunnallisjärjestö waatii kunnanwaroja punakaartilaisten palkoiksi 1,000,000 mk.</h5>
        <p>Helsingin punakaarti päätti wiime sunnuntaina waatia kaupungin waltuustolta kunnanwaroista palkoikseen miljoonaan markkaa. Summa on maksettawa ennen keskiwiikkoa klo 3 uhalla, että se 
          sen jälkeen otetaan wäkipakolla.</p>
        <p>Päätöksensä punakaarti kuitenkin alisti Helsingin työwäen järjestöjen eduskunnan harkittawaksi, joka samana iltana päätti alistaa asian kunnallisjärjestön ratkaistawaksi, ehdottaen, 
          että summa waadittaisiin jaettawaksi hätääkärsiwille työttömille rawintoaineina ja waatetusapuna.</p>
        <p>Ehdotus oli maanantaina illalla käsiteltäwänä Helsingin kunnallisjärjestön kokouksessa. Pitkässä ja kiihkeässä keskustelussa tehtiin muun ohella sellainen ehdotus, että waaditusta 
          summasta ensin maksettaisiin palkat koko punakaartille suurlakkoajalta ja niille 299 miehelle, jotka owat pitäneet „wartiota” suurlakon jälkeen, ja sitten mitä jää jaettaisiin 
          awustukseksi hätääkärsiwille.</p>
        <p>Tämä ehdotus woitti työwäen järjestöjen eduskunnan ehdotuksen 300 äänellä 217 ääntä wastaan ja tuli siis kunnallisjärjestön päätökseksi. Päätöstä wastaan merkittiin suuri joukko 
          wastalauseita, joissa pidettiin aiwan kohtuuttomana, että puolue waatii yleisiä kunnanwaroja omalle puoluekaartilleen ja antaa ainoastaan rippeet todella puutteenalaisille.</p>
        <p>Kokouksessa ehdotettiin, että määräaikaa jatkettaisiin lauantaihin tämänkuun 8 päiwään, mutta kokouksen enemmistö, jonka muodostiwat juuri punakaartilaiset, yhtyi punakaartin 
          uhkawaatimukeeen, että miljoona on maksettawa keskiwiikkona klo 8:een mennessä.</p>
        <p>Siitä, mihin toimenpiteisiin muussa tapauksessa ryhdytään, ei tehty selwää päätöstä. Jotkut puhujat uhkailiwat kunnallislakolla, mutta punakaartilaisten taholta ilmoitettiin jyrkästi, 
          että miljoona muitta mutkitta „otetaan”.</p>
      </Article>

      <div className="interTitle">8.12.1917</div>
      <Article titleText="Punakaartit jatkawat ryöstöretkiään.">
        <p>Wiime maanantaina t. k. 3 pnä ilmestyi monikymmenlukuinen roswojoukko, joiden päämaja nyt kuuluu siirtyneen Malmille, arwattawasti Saksanniemeltä waltiolta warastaminensa hewosineen 
          Nurmijärwen kirkonkylään ja Perttulan kylään, joissa he aseilla uhaten monesta talosta wäkiwalloin weiwät lähes kaikki elintarpeet ja heiniä. Jotta tämä roswous käwisi esteettömämmin 
          päinsä, antoiwat he jo etukäteen w. k. 28 pnä nimismies K. I. Thesmannille määräyksen, että hänen oli henkensä uhalla jätetettäwä kaikki wirkatehtäwänsä, minkä ohessa roswot ampumisen 
          uhalla pakottiwat poliisikonstaapeli Eliel Kjäldmanin heti jättämään erohakemuksensa poliisin toimesta, minkä K. tekikin. — U. S.</p>
      </Article>

      <div className="interTitle">11.12.1918</div>
      <Article titleText="Väkivalta valtuustoja kohtaan.">
        <h5>Tampereella jälleen mellakoita ja waltuusto piiritettynä.</h5>
        <p>Lauantai-iltana oli Tampereen kaupunginwaltuustossa jälleen käsiteltäwänä kaupungin ulkotyöläisten palkankorotuswaatimus, josta kuten muistetaan, t. k. 5 pnä sanotun kaupungin 
          ulkotyöläiset ottiwat aiheen sulkea waltuuston yli 20 tunniksi istuntosaliin. Waltuusto hylkäsi työläisten tuntipalkkain korotuksia koskewat waatimukset, suostuen sensijaan heidän 
          esittämiinsä lapsi-awustusta koskewiin waatimuksiin. Tämän jälkeen waltuusto ryhtyi käsittelemään muita asioita. Järjestyksessä seuraawana ollut kysymys päästiin onnellisesti loppuun, 
          mutta kolmannen asian ollessa esillä ryntäsi työläisiä istuntosaliin ja nostiwat he niin hirwittäwän metelin, että puheenjohtaja katsoi olewansa pakoitettu lopettamaan istunnon. Tämän 
          jälkeen aikoiwat waltuusmiehet poistua, mutta siitä estiwät heidät työläiset, joita oli käytäwä täynnä. Syntyneessä tungoksessa kaadettiin waltuusmies, tehtailija Rafael Haarla maahan ja 
          iskettiin häntä puukolla reiteen. Erästä huligaania puukottiwat hänen kumppaninsa samassa mylläkässä pahasti selkään, niin että miehen henki on waarassa.</p>
        <p>Torilla kaupungintalon edustalla oli samaan aikaan paljon wäkeä. Waltuustoa piirittäwäin joukossa näkyi humalaisia.</p>
        <p>Waltuusmiehistä laskettiin Ruotsin konsuli Gösta Sumelius kohta pois, samoin prof. Backman.</p>
        <p>Klo 10 illalla saapui paikalle osa Tampereen punakaartia, muutamia kymmeniä kiwääreillä warustettuina. Punakaarti tyhjensi kaupungintalon työläisistä ja siirsi waltuusmiehet samassa 
          rakennusryhmässä olewan poliisilaitoksen puolelle, jonne heidän oli jäätäwä. Ruokaa woitiin heille sinne toimittaa ja saiwat he olla puhelinyhteydessäkin kaupungille.</p>
        <p>Tapahtumasta on toimitettu tieto senaattiin.</p>
        <p>Puolenyön jälkeen oliwat waltuusmiehet yhä wielä poliisikamarin kansliahuoneessa. Kaupungintalon ulko-owilla sekä läheisillä kaduilla pitiwät kiwääreillä warustetut punakaartilaiset 
          yllä järjestystä. Läänin kuwernööri Saarinen oli kaupungissa, mutta mikäli tiedetään, ei hän onnistunut saamaan aikaan wälitystä.</p>
        <h5>Wiipurin kaupunginwaltuusto pidätettynä.</h5>
        <p>Wiime perjantaina klo 6 ip. kokoontui Wiipurin kaupunginwaltuusto käsittelemään yksinomaan työttömyyskysymyksiä.</p>
        <p>Sitäpaitsi oli waltuuston käsiteltäwänä waatimus, että töitä on työttömille järjestettäwä heti ja että joka tapauksessa oli työttömille suoritettawa tilitys lauantaina. Tähän 
          waatimukseen ei waltuusto woinut ilman muuta suostua.</p>
        <p>Waltuuston tekemäin päätösten johdosta työttömät piirittiwät istuntotalon ja lähettiwät lähetystön waltuusmiehille ilmoittamaan, että he eiwät pääse talosta minnekään, ennenkuin 
          työttömien mieleiset päätökset on tehty. Waltuusmiehet ilmoittiwat lähetystölle, etteiwät he asian näin ollen woi ottaa kysymyksiä uuden käsittelyn alaiseksi ennenkuin työttömät 
          luopuwat kaikesta pakoituksesta.</p>
        <p>Tästä huolimatta työttömät jatkoiwat piiritystä. Myöhemmin saapuiwat paikalle Wiipurin sos.-dem. kunnallisjärjestön ja työwäenjärjestöjen eduskunnan edustajat, jotka yrittiwät ryhtyä 
          wälittämään. Tämä toimenpide kuitenkin raukesi, sillä kumpikaan puoli ei suostunut myönnytyksiin.</p>
        <p>Lauantai-aamuna klo 6 lopetettiin piiritys ehdolla, että waltuusto kokoontuu uudelleen klo 11 käsittelemään polttawaa työttömyyskysymystä koko laajuudessaan.</p>
      </Article>
      <Article titleText="Taas aseita punakaarteille.">
        <h5>86 kuularuiskua saapunut.</h5>
        <p>Aseiden kuljetus Wenäjältä Suomen punakaarteille näkyy jatkuwan, ilmoitetaan Pietarista Dag. Pr:lle. Wiime torstaina kuormattiin Pietarin Suomen-asemalla 86 kuularuiskua wannuihin ja 
          kuljetettiin samana päiwänä Suomeen. Nämäkin aseet toimitti komisari Rahja, joka 10—12 suomalaisen punakaartilaisen kanssa wäkisin waltasi itselleen waunut ja toimitti ne kuljetetuiksi 
          Suomeen. Minne kuularuiskut kuljetettiin, ei tiedetä warmasti, mutta arwellaan niiden joutuneen Lahteen. Lähetystä seurasi 10—12-miehinen punakaarti.</p>
      </Article>

      <div className="interTitle">13.12.1917</div>
      <Article titleText="Julkeata sananvapauden loukkaamista.">
        <h5>Wenäläiset sotamiehet estäneet Tampereen Sanomat ilmestymästä. — Punakaartilaisiakin mukana.</h5>
        <p>Toissa yönä klo 1 aikaan saapui Tampereen Sanomain kirjapainoon 10 wenäläistä sotamiestä 3 täkäläisen punakaartilaisen ollessa apureina ja oppaina, miehittäen kirjapainon ja waatien 
          lopettamaan työt. Paikalle toimituksesta rientäneelle toimittajalle ilmoitettiin, että toistaiseksi lakkautetaan lehden ilmestyminen. Samalla hänelle annettiin kaupungin komendantin 
          allekirjoittama wenäjänkielinen kirjelmä, jossa ilmoitetaan, että lehti lakkautetaan täkäläisen työ- ja sotamiesneuwoston waatimuksesta. Työt oli lopetettawa, ja sotamiehet asettuiwat 
          painon owille wartioimaan ilmoittaen samalla, että he wastaawat siitä, ettei mitään warasteta. Myöhemmin tuli aseellinen patrulli myöskin toimitukseen ja asettui toimittajien 
          poistuttua ulkoeteiseen wartioimaan.</p>
        <p>Jo aikaisemmin illalla oli lehden toimituksessa käynyt samainen lähetystö, jossa kuuleman mukaan oli mukana joku wiipurilainen „komissaari”, joka wartawasten oli tänne tämän asian 
          johdosta matkustanut, tiedustelemassa, kuka oli lehden wiime marraskuun 22 p:n numerossa olleen uutisen, jossa joukko 422 kolppanalaisen jalkawäkirykmentin upseereita ja sotamiehiä 
          ilmoitti olewansa bolshewikeja wastaan, kirjoittaja, jota luonnollisesti ei ilmoitettu. Lähetystö poistui silloin saamaan määräyksiä ja waltuuksia lehden lakkauttamiseen kaupungin 
          komendantilta, joka sellaisen sitten antoikin.</p>
      </Article>

      <div className="interTitle">18.12.1917</div>
      <Article titleText="Mellastusta Turussa.">
        <p>Sunnuntaina klo 11 aikaan illalla alkoi Turussa hirweä pogromi. Asestetut miesjoukot alkoiwat särkeä kiwillä ja ampuma-aseilla liikkeiden näyteakkunoita ja ryöstää liikkeitä. Aamuun 
          saakka jatkui hillitön häwitys. Seurauksena oli, että keskikaupungilla suurten liikkeiden kalliit näyteakkunat owat säpäleinä ja niistä on ryöstetty paljon omaisuutta. Muutamia 
          henkilöitä haawoittui, mutta toistaiseksi ei liene kuolleita.</p>
        <p>Maanantaina klo 5 aikaan aamulla asestetut miesjoukot waltasiwat postitalon pakottaen sen lakkotilaan. Suomen pankki ja yksityispankit sekä tullikamari oliwat eilen suljettuina.</p>
        <p>Mikäli tähän asti tiedetään on liikkeistä wiety useiden kymmenien tuhansien arwosta omaisuutta. Erään liikkeen wahingot nousewat ainakin 60,000 mk. Ryöstettyjä ja häwitettyjä 
          liikkeitä on kaikkiaan n. 60.</p>
        <p>Ryöstöön otti osaa waimoja ja lapsia puhumattakaan sotilaspukuisista henkilöistä, jotka kantoiwat ryöstettyjä tawaroita sylikaupalla automobiileihin.</p>
        <p>Sunnuntaina aamulla tapahtui 2 murhapoltonyritystä Turun Sanomain kirjapainossa. Tuli sai aikaan useamman tuhannen markan wahingon.</p>
      </Article>

      <div className="interTitle">20.12.1917</div>
      <Article titleText="Roistowalta Turussa.">
        <h5>Liikkeitä ryöstetty jälleen kymmenittäin, m. m. Nordforssin wäkijuomaliike. — Miliisi edelleenkin puuttumatta asiaan.</h5>
        <p>Klo 9 jälestä maanantaina illalla tuntui kaupungissa willintyminen jälleen pääsewän waltaan. Kaupungilta kuului melua ja laukauksiakin ja ainakin muutamien liikkeiden akkunoita taasen 
          särjettiin.</p>
        <p>Strandellin Herrain waatetusliikkeeseen tunkeuduttiin ensinnä, sitten kun suuret näyteakkunat oli lyöty rikki. Koko liike ryöstettiin sanan täydessä merkityksessä, sillä ryöstäjien 
          poistuttua ei liikkeessä ollut yhtään koskematonta hyllyä. Tawaroita kantoiwat pois huligaanit ja näitä seuranneet katunaiset y. m.</p>
        <p>Wähää ennen klo 11 illalla tunkeutuiwat roskajoukot Jakubowitsin waatetusliikkeeseen Teatteritalossa torin warrella. He ennättiwät ryöstää liikkeestä noin 10,000 mk. arwosta tawaroita 
          ennenkuin liikkeen omistaja joka on Wenäjän alamainen, ennätti sotilaskomitealta saada apua ja sieltä lähetetyt sotilaat estää enemmän ryöstön.</p>
        <p>Klo puoli 12 aikaan yöllä kuului kaupungilta woimakas tykinlaukaus. Iltayöstä näkyi kaduilla siellä täällä joku sotilaspatrulli.</p>
        <p>Myöhemmin yöllä ryöstöt jatkuiwat taukoamatta. Ennenmainittujen lisäksi ryöstettiin Rintalan kenkäliike ja Nordsorssin wäkijuomawarastoja. Pelätään että wäkiwallan teot wäkijuomien 
          waikutuksesta saawuttawat yhä suuremman laajuuden.</p>
        <p>Keskiyön jälkeen sitten ryöstöt jatkuiwatkin täydessä wauhdissa, ehkä wielä entistäkin raiwokkaimpina. Muutamista liikkeistä rewittiin akkunoiden edessä olewa laudoitus, toisista oli 
          nostettu hyllyt kadulle missä tawarain jako tapahtui. Pitkin katuja on kenkiä, kaulahuiweja y. m tawaroita hujan hajan. Yhtä mittaa kuului ammuntaa. Roswojoukot liikkuiwat kaduilla 
          30—60 miehisin joukoin.</p>
        <p>Myöhemmin ilmoitettiin, että roswot, jotka tähän saakka oliwat toimineet wain kaupungin keskuksessa, alkoiwat lewitä myös siwukaduille. M. m. he tyhjensiwät muutamia kauppoja 
          Humaliston kadulla ja sen läheisyydessä.</p>
        <p>Nordforssin pihassa muodostui ketju, jota pitkin wäkijuomatawarat kulkiwat kellareista. Roswojen ryöstöhalun esineeksi joutuiwat etupäässä kenkä- ja waatetusliikkeet. — Toissa yönä 
          nousiwat wahingot huomattawiin summiin. Strandellin liikkeestä wietiin tawaroita 60,000 -80,000 mk arwosta ja sen wiereisessä jalkineliikkeessä owat wahingot wielä suuremmat. — A. U. 
          talon wielä eheät ikkunat hakattiin rikki klo 12 aikaan.</p>
        <p>Aamupuolella oliwat Wenäjän kirkkokatu ja Humalistonkatu kokonaan ryöstetyt. Pankkeihin ei wielä ainakaan oltu käyty käsiksi, mutta oltiin siinä suhteessa sangen lewottomia, koska 
          kaduilla riehuwien roistojen kesken useasti kuultiin puhuwan pankeista. Wain harwoissa paikoissa yritettiin ampumalla pelottaa roistoja ja tällöinkin wain tyydyttiin laskemaan laukaus 
          tai pari ilmaan.</p>
      </Article>

      <div className="interTitle">8.1.1918</div>
      <Article titleText="Wenäläiset sotilaat ja punakaartilaiset mellastaneet Savonlinnassa.">
        <p>Lauantaina saapui Sawonlinnaan ylimääräisellä junalla 300 sotilasta, jotka oliwat lähteneet liikkeelle Haminasta ja Kotkasta. Sawonlinnasta lähtiwät sotilaat samana iltana paluumatkalle 
          selittäen tulleensa auttamaan sikäläisiä sosialisteja porwareja wastaan, mutta tulleensa petetyiksi. Putikon aseman seuduilla sotilaat kuitenkin joutuiwat toiselle mielelle ja palasiwat 
          uudelleen kaupunkiin. Kaupungissa he waltasiwat sunnuntai-aamuna yhdessä punakaartin kanssa puhelin- ja sähkölennätinaseman sekä tunkeutuiwat asemahuoneustoon. Aamupäiwällä alkoiwat 
          punakaartilaiset yhdessä sotilaiden kanssa toimeenpanna kotitarkastuksia ja wangitsemisia, wangiten m. m. kruununwouti Mannisen, asemapäällikkö Öllerin y. m. Kaikkiaan lienee wangittu 
          n. 50—60 henkilöä, jotka kuljetettiin työwäentalolle - Useimpia wangituita syytetään suojeluskuntaan kuulumisesta ja työwäen pyrintöjen wastustamisesta. Toissa yönä alkoi työwäen 
          tuomioistuin kuulustella wangituita, joita waadittiin allekirjoittamaan sitoumuksia, joissa esitettiin kaikenlaisia häpeämättömiä waatimuksia. Useat kieltäytyiwät sitoumuksista. Klo 5 
          eilen aamulla wapautettiin wiimeiset wangituista, ehdolla että he saapuisiwat klo 12 työwäentalolle. Kolme syytetyistä, niiden joukossa asemapäällikkö Oller, uhattiin 
          wastawallankumouksellisina lähettää Kronstadtiin tuomittawiksi. Senaatin sisäasiainpäällikkö sen. Castrén teki asiasta tiedon saatuaan ilmoituksen sotilaskomitealle, joka lähetti heti 
          sähkösanoman Sawonlinnaan käskien sotilaita poistumaan. Kun sähkölennätinlaitos oli punakaartilaisten wallassa ei sähkösanoma liene joutunut sotilaiden käsiin. Mikkelistä ja Wiipurista 
          on ylimääräisillä junilla lähtenyt paikkakunnalle erinäistä luottamushenkilöitä palauttamaan rauhallisuuden.</p>
      </Article>
      ...
      <Article titleText="Skandinavian maiden alamaiset ja punakaartin väkivallanteot maassamme.">
        <h5>Sos.-dem. eduskuntaryhmää waaditaan lopettamaan wäkiwallanteot, uhalla että apua pyydetään muuten Skandinawian hallituksilta.</h5>
        <p>Skandinawian maiden alamaisten puolesta jätettiin lauantaina sos. dem. eduskuntaryhmälle sos. dem. puoluetoimikunnalle osotettu näin kuuluwa wastalause:</p>
        <p className="quote">Suomessa asuwan kaikkiin yhteiskuntaluokkiin kuuluwan skandinawialaisen wäestön edustajina kehoitamme täten teitä punaisen kaartin perustajana huolehtimaan siitä, että 
          aseistetut joukot lopettawat ryöwäyksensä, wäkiwaltaisuutensa y.m. yleistä rauhaa häiritsewät tekonsa.<br />Kun Suomen tasawalta, joka nyt astuu itsenäisten waltojen riwiin, läheisesti 
          liittyen, kuten toiwomme, Skandinawiaan, on saanut itsenäisyytensä Skandinawian waltojen puolelta tunnustetuksi, on näiden waltioiden wäestö oikeutetttu odottamaan, että Suomen kansa 
          täysin pitää kunniassa siwistyselämän waatimuksia wastaawia oikeuskäsitteitä, niin että Suomen waltio woi tarjota kaikille tässä maassa asuwille lakiin perustuwan oikeusturwan. Suomessa 
          on wakinaisesti asumassa kymmeniä tuhansia skandinawialaisia, jotka eiwät tyynin mielin woi katsella kuinka anarkia uudestaan lewiää maahan, ja sen wuoksi pidämme oikeutenamme waatia, 
          että turwattu järjestys palautetaan, sitäkin suuremmalla syyllä kun wäkiwallanteot ja murhat jo owat kohdistuneet maassa asuwiin Skandinawian alamaisiin.<br />Tätä ei mielestämme woida 
          muuten aikaansaada kuin riisumalla aseet rauhattomalta wäestöainekselta, ja kehoitamme me sen wuoksi teitä wiipymättä ja witkastelematta ryhtymään mahdollisimman tarmokkaisiin 
          toimenpiteisiin tässä suhteessa.<br />Sanomalehdistön kautta on teille warmaan tunnettua, että Skandinawian maat, Ruotsi, Norja ja Tanska owat tehneet ja aikowat edelleen tehdä suuria 
          uhrauksia auttaakseen Suomea elintarpeilla, huolimatta siitä, että Skandinawian wäestöltä itseltään puuttuu suuri osa hengen ylläpitämiteksi tarwittawia wälttämättömämpiä 
          elintarpeita.<br />Tähän nähden ja huomioon ottaen että Skandinawiassa asuwilla Suomen kansalaisilla on ehdoton lain turwa, hengen, elinkeinon ja omaisuuden puolesta, me katsomme 
          oikeudeksemme jyrkästi waatia, että täälläkin säännöllinen oikeustila wiipymättä aikaansaadaan. Ellei näin tapahdu, olemme pakoitetut edustajiemme wälityksellä kääntymään maittemme 
          hallitusten puoleen apua saadaksemme.<br /><span className="signature">Helsingissä, 11 pnä tammikuuta 1918.</span></p>
        <p>Alla neljän Ruotsin alamaisen, neljän Tanskan ja neljän Norjan alamaisen nimikirjoitukset. Allekirjoittajat edustawat Skandinawian maiden alamaisia kaikista yhteiskuntaryhmistä ja owat 
          sen hywäksyneet kaikki 5 Heisingissä olewaa skandinawilaista yhdistystä.</p>
      </Article>
      ...
      <Article titleText="Sotilaat mellastamassa.">
        <h5>Ahdistawat miliisiä. — Ampuneet pitkin katuja.</h5>
        <p>Wiime lauantai-iltana, kun työwäen Järjestyskaartilla oli iltama täkäläisellä Työwäentalolla, oli sinne saapunut myöskin sotilaita, joukossa m. m. eräs kaupungissa yleiseen tunnettu 
          Herbert Brido, juopuneena ja esiintyen häiritsewästi, wälittämättä kaartin järjestysmiehen Wihtori Haawan kiellosta, joten hänet lopuksi ajettiin ulos. Lähtiessään uhkasi B. tulla 
          takaisin ja näyttäwänsä mitä kuuluu, jättäen m. m. sinellinsä eteiseen. Iltaman loputtua olikin Brido kerännyt sotilaita kokoon ja kun yllämainittu Haapa klo ½1 ajoissa yöllä oli 
          matkalla kotiaan parin towerinsa kera, hyökkäsiwät sotilaat heidän kimppuunsa Hallitus- ja Kasarmikadun kulmassa, alkaen ampua noin 15 m. etäisyydeltä, kuitenkaan osaamatta. Ahdistetut 
          saiwat sanan järjestyslaitokselle, josta heti lähti liikkeelle wiisi miestä. Kiertäen Raastuwankadun kautta kulkiwat miehet wenäläiselle kirkolle, mutta kirkon puistoon saawuttua 
          alkoiwat sotilaat winhasti ampua, kuitenkaan osaamatta. Huomattuaan järjestysmiesten kääntyneen takaisin alkoiwat sotilaat seurata jälestä huutaen „miliisit ampuiwat”, samalla itse 
          yhä ampuen. Sotilaita oli joukossa parikymmentä ja anastiwat he m. m. yhteiskoulun kulmassa passissa olewalta konstaapeli K. Järwiseltä, rewolwerit ohimoon kohdistettuina, rewolwerin, 
          luowuttaen sen kuitenkin takaisin.</p>
        <p>Silläwälin oli tieto ampumisesta saapunut kasarmiin, mistä soitettiin järjestyslaitokselle kysyen sen syytä. Täältä ilmoitettiin sotilaiden ampuwan järjestysmiehiä ja yleisöä. 
          Kasarmilta lähetettiin silloin patrulli, joka pidätti Bridon ja muutamia pahimpia mellakoitsijoita wieden heidät kasarmiin.</p>
      </Article>
...
export default PreCivilWarPage 